...
<div class="topbar"><div class="wrap tb-row">
  ...
  <span class="tb-links">
    <a href="tel:{{ config('ukv.phone_e164') ?: '+440000000000' }}">@include('partials.call-glyph')UK team {{ config('ukv.phone') ?: '+44' }}</a>
    <a href="tel:{{ config('ukv.phone_de_e164') ?: '+490000000000' }}">@include('partials.call-glyph')Germany team {{ config('ukv.phone_de') ?: '+49' }}</a>
