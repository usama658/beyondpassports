...
<div class="topbar"><div class="wrap tb-row" style="justify-content:flex-end">
  ...
  <span class="tb-links">
    <a href="tel:{{ config('ukv.phone_e164') ?: '+447520684030' }}">@include('partials.call-glyph')<b>UK Team:</b>&nbsp;{{ config('ukv.phone') ?: '+44' }}</a>
    ...
    <a href="https://wa.me/{{ config('ukv.whatsapp') ?: '447520684030' }}">@include('partials.wa-glyph')WhatsApp</a>
