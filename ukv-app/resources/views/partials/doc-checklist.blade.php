...
<div class="doc-checklist" role="region" aria-label="{{ $heading }}">
  <style>
    ...
    .doc-checklist{font-family:"Plus Jakarta Sans",system-ui,-apple-system,"Segoe UI",Roboto,sans-serif;color:#16222E}
    .doc-checklist .dc-head{font-family:"Plus Jakarta Sans",system-ui,sans-serif;font-weight:700;font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#155E7A;margin:0 0 6px}
    ...
    .doc-checklist .dc-group-name{font-family:"Plus Jakarta Sans",system-ui,sans-serif;font-weight:800;font-size:13px;letter-spacing:.08em;text-transform:uppercase;color:#155E7A;border-bottom:1px solid #dde3ec;padding:0 0 9px;margin:0 0 14px}
