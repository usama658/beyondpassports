...
<form class="bpc-af" onsubmit="return bpcAppt(this)" novalidate>
  ...
  <p class="bpc-af-sub">Just your name and number. A UK &amp; Europe advisor spots what could get you refused, then holds the soonest slot before it goes.</p>
  ...
  <p class="bpc-af-trust"><span class="bpc-af-dot"></span> Reply in minutes · No payment now · <b>UK &amp; Europe</b> team</p>
</form>
<script>
function bpcAppt(f){
