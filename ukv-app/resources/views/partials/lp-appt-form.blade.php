...
<form class="bpc-af" onsubmit="return bpcAppt(this)" data-capture="{{ route('appointment.enquiry') }}" novalidate>
  ...
  <p class="bpc-af-sub">Just your name and number. A <x-reg-verify>UK &amp; Europe registered</x-reg-verify> service spots what could get you refused, then holds the soonest slot before it goes.</p>
