...
@else
<div><a href="https://find-and-update.company-information.service.gov.uk/company/{{ config('ukv.company_no') ?: '17331903' }}" target="_blank" rel="noopener" title="Verify our UK registration on Companies House" style="color:inherit;text-decoration:none"><div class="n">@include('partials.uk-eu-flags',['size'=>28])</div><div class="l">Registered in England and Wales</div></a></div>
@endif
