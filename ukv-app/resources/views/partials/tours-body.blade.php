...
<section class="tr-sec tr-how"><div class="wrap">
  <div class="sec-head">
    ...
    <h2>We prepare the documents first. Then you travel.</h2>
  ...
  <div class="steps">
    ...
    <div class="step"><div class="num">02</div><h3>We prepare the documents</h3><p>We build the application the way a consulate reads it, and lock in the appointment before slots go.</p></div>
...
(function () {
  ...
  function wire(btnSel, nameId, phoneId, destId) {
    ...
    function build() {
      ...
      btn.href = 'https://wa.me/{{ config('ukv.whatsapp') ?: '4915213103462' }}?text=' + encodeURIComponent(msg);
    }
