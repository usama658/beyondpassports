...
<section id="values" class="alt"><div class="wrap">
  ...
  <div class="ab-values">
    ...
    <div class="ab-value reveal">
      ...
      <h3>Care</h3>
      <p>Real people on the phone and on WhatsApp. People you can actually talk to when something matters, <x-reg-verify>registered in England and Wales</x-reg-verify>.</p>
    </div>
  ...
  <div class="rgrid">
    @php
      $reviews = [
        ...
        ['P','Priya Sharma','Jun 2026','BP-2026-100227','I\'m on a UK residence permit and wasn\'t sure I could even apply. Their agent walked me through it, sorted my Germany visa, no drama at the consulate. Fair fee and a real person answered every email.'],
...
@php
  ...
  $cases = [
    ...
    ['ref','Italy visa','Italian Consulate London · Middle Eastern passport','Refused twice previously. Consulate cited insufficient ties to home country.','Built a comprehensive ties-to-home file: property, employment contract, family documentation. Cover letter addressed prior refusals directly.','Approved, single entry','10','Previous refusal','Yusuf A.'],
...
{{-- GET IN TOUCH — unified concierge card (petrol rail + white actions) --}}
@php
  $touchWa = 'https://wa.me/' . (config('ukv.whatsapp') ?: '447520684030') . '?text=' . rawurlencode('Hi Beyond Passports, here is my situation: ');
...
<section id="contact" class="abc6"><div class="wrap reveal">
  <div class="card">
    <div class="rail">
      ...
      <p class="lede">Tell us your situation and we will come back to you within 30 minutes. If we cannot improve your application, we say so upfront. No charge for the review.</p>
      <ul class="cl">
        @foreach ($touchList as $item)
        <li>{!! $touchTick !!}<span>{{ $item }}</span></li>
        @endforeach
      </ul>
      <span class="chip"><svg viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 8v4l3 2"/></svg>We respond within 30 minutes</span>
    </div>
    <div class="act">
