...
{{-- GET IN TOUCH — unified concierge card (petrol rail + white actions) --}}
@php
  $touchWa = 'https://wa.me/' . (config('ukv.whatsapp') ?: '4915213103462') . '?text=' . rawurlencode('Hi Beyond Passports, here is my situation: ');
