...
<div class="nearest-centre" role="region" aria-label="{{ $heading }}">
  <style>
    ...
    .nearest-centre .nc-empty{font-size:14.5px;color:#697079;background:#f7fafb;border:1px dashed #e6e8ea;border-left:3px solid #C75D38;border-radius:8px;padding:16px 18px;margin:0;line-height:1.55}
    ...
    .nearest-centre .nc-card{border:1px solid #e6e8ea;border-radius:10px;background:#fff;padding:18px 20px}
    .nearest-centre .nc-card.is-booked{border-color:#C75D38;box-shadow:0 0 0 1px rgba(199,93,56,.35)}
    ...
    .nearest-centre .nc-name{font-size:17px;font-weight:600;color:#22282b;margin:0;line-height:1.3}
    .nearest-centre .nc-dist{font-family:"Plus Jakarta Sans",system-ui,sans-serif;font-size:12px;color:#697079;white-space:nowrap;letter-spacing:.02em}
