...
<svg width="0" height="0" style="position:absolute" aria-hidden="true" focusable="false">
  ...
  <symbol id="ukv-route" viewBox="0 0 400 200">
    ...
    <circle cx="360" cy="110" r="6" fill="#2F8F86"/>
    <circle cx="360" cy="110" r="11" fill="none" stroke="#2F8F86" stroke-opacity=".4"/>
  ...
  <symbol id="ukv-stamp" viewBox="0 0 48 48">
    <g transform="rotate(-8 24 24)" fill="none" stroke="#2F8F86" stroke-width="2">
