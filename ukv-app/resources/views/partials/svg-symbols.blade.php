...
<svg width="0" height="0" style="position:absolute" aria-hidden="true" focusable="false">
  ...
  <symbol id="ukv-route" viewBox="0 0 400 200">
    <g fill="none" stroke="#155E7A" stroke-width="2" stroke-dasharray="2 7" stroke-linecap="round">
      <path d="M40 150 Q200 10 360 110"/>
    </g>
    <circle cx="40" cy="150" r="6" fill="#155E7A"/>
    <circle cx="40" cy="150" r="11" fill="none" stroke="#155E7A" stroke-opacity=".35"/>
    <circle cx="360" cy="110" r="6" fill="#2E9A8C"/>
    <circle cx="360" cy="110" r="11" fill="none" stroke="#2E9A8C" stroke-opacity=".4"/>
  ...
  <symbol id="ukv-stamp" viewBox="0 0 48 48">
    <g transform="rotate(-8 24 24)" fill="none" stroke="#2E9A8C" stroke-width="2">
  ...
  <symbol id="sky-generic" viewBox="0 0 240 96" preserveAspectRatio="xMidYMax meet">
    <g fill="#1F6E63">
      ...
      <circle cx="110" cy="36" r="14" fill="none" stroke="#155E7A" stroke-width="2"/>
    </g>
  </symbol>
