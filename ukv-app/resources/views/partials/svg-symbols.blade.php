...
<svg width="0" height="0" style="position:absolute" aria-hidden="true" focusable="false">
  ...
  <symbol id="ukv-route" viewBox="0 0 400 200">
    <g fill="none" stroke="#C75D38" stroke-width="2" stroke-dasharray="2 7" stroke-linecap="round">
      <path d="M40 150 Q200 10 360 110"/>
    </g>
    <circle cx="40" cy="150" r="6" fill="#C75D38"/>
    <circle cx="40" cy="150" r="11" fill="none" stroke="#C75D38" stroke-opacity=".35"/>
    <circle cx="360" cy="110" r="6" fill="#5C9A7B"/>
    <circle cx="360" cy="110" r="11" fill="none" stroke="#5C9A7B" stroke-opacity=".4"/>
  ...
  <symbol id="ukv-stamp" viewBox="0 0 48 48">
    <g transform="rotate(-8 24 24)" fill="none" stroke="#5C9A7B" stroke-width="2">
  ...
  <symbol id="ukv-monogram" viewBox="0 0 44 44">
    <rect width="44" height="44" fill="#22282b"/>
    <text x="22" y="29" text-anchor="middle" font-family="Plus Jakarta Sans,system-ui,sans-serif" font-weight="700" font-size="16" fill="#C75D38">UK</text>
  </symbol>
  ...
  <symbol id="sky-generic" viewBox="0 0 240 96" preserveAspectRatio="xMidYMax meet">
    <g fill="#3f7259">
      ...
      <circle cx="110" cy="36" r="14" fill="none" stroke="#C75D38" stroke-width="2"/>
    </g>
  </symbol>
