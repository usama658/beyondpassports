  ...
  <div class="bpc-ftmain"><div class="bpc-wrap">
    <div class="bpc-cols">
      ...
      <div class="bpc-col">
        ...
        <a href="{{ App\Support\SiteStats::chatUrl() }}" target="_blank" rel="noopener">Free case check →</a>
      </div>
      <div class="bpc-col">
    ...
    <div class="bpc-ftbottom">
      ...
      <a href="https://find-and-update.company-information.service.gov.uk/company/{{ config('ukv.company_no') ?: '17331903' }}" target="_blank" rel="noopener" title="Verify our UK registration on Companies House" style="display:inline-flex;align-items:center;gap:7px;color:inherit;text-decoration:none">@include('partials.uk-eu-flags',['size'=>14])Registered in England and Wales</a>
    </div>
  </div></div>
</footer>
@once
