...
<style>
  ...
  .tm-sum::before{content:"";position:absolute;inset:0;background:radial-gradient(70% 70% at 90% 0,rgba(21,94,122,.30),transparent 60%),radial-gradient(60% 70% at 0 100%,rgba(46,154,140,.30),transparent 62%)}
...
<section class="alt" aria-labelledby="testimonials-head"><div class="wrap">
  <div class="tm-wrap">
    ...
    <aside class="tm-sum reveal">
      ...
      <p>Every review here is shared with the traveller's consent and anonymised.</p>
      @if ($showAll)
