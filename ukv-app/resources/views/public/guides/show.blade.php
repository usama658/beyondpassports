...
<section class="cta-band"><div class="wrap reveal">
  ...
  <p style="max-width:48ch;color:#eef0f1">Check what your trip needs, or start your application. Our <x-reg-verify>England and Wales registered</x-reg-verify> service removes the avoidable causes of refusal before it's submitted.</p>
  <div class="row">
