  <p>If you've started planning a trip, you've probably seen both words used almost interchangeably. The travel page says you need an "ETA", a forum post says "visa", and a friend insists you don't need anything at all. They can all be right, just for different people. Below is the plain-English version.</p>
  ...
  <ul>
    ...
    <li><strong>Evidence:</strong> with an ETA there's nothing to carry because it's recorded electronically; with a visa you may have a sticker, stamp or record to show.</li>
  </ul>
  ...
  <ul>
    <li>Know your <strong>nationality and country of residence</strong>, as both can affect what you need.</li>
    ...
    <li>Confirm your <strong>purpose and length of stay</strong>, since tourism, business and longer visits can have different rules.</li>
    <li>Apply <strong>in good time</strong>, especially for visas, which can take longer than expected.</li>
  </ul>
  <p>If you'd rather not piece it together yourself, you can <a href="{{ url('/tools') }}">use our checker</a> to see what applies to your trip, and we'll confirm the details for your nationality and destination.</p>
