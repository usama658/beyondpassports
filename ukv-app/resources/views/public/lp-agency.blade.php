...
.sva .cfaq .fcard.open .qg{background:var(--stamp);color:#fff}
.sva .cfaq .fcard.key .qg{background:#fdecea;color:var(--red)}
.sva .cfaq .fcard.key.open .qg{background:var(--red);color:#fff}
.sva .cfaq .pm{margin-left:auto;color:var(--cta);font-size:28px;line-height:.7;flex:none;transition:transform .18s}
.sva .cfaq .fcard.open .pm{transform:rotate(45deg)}
.sva .cfaq .fa{max-height:0;overflow:hidden;transition:max-height .24s;margin:0}
.sva .cfaq .fcard.open .fa{max-height:680px}
...
@keyframes pkdot{0%,100%{opacity:1;box-shadow:0 0 0 5px rgba(225,29,29,.22)}50%{opacity:.4;box-shadow:0 0 0 5px rgba(225,29,29,0)}}
@media(prefers-reduced-motion:reduce){.sva .peak-badge,.sva .peak-badge .pk-dot{animation:none}}
...
.sva .lpb .ngband{position:relative;overflow:hidden;background:linear-gradient(160deg,#132c34,#1F6E63);border-radius:16px;padding:15px 16px;margin:0 0 14px}
.sva .lpb .ngband::after{content:'';position:absolute;right:-60px;top:-80px;width:220px;height:220px;border-radius:50%;background:radial-gradient(circle,rgba(143,227,201,.18),transparent 65%);pointer-events:none}
.sva .lpb .nghint{position:relative;z-index:1;font-size:14px;font-weight:800;color:#fff;margin:0 0 9px}
.sva .lpb .nghint b{color:#8fe3c9;font-weight:800}
.sva .lpb .nghint span{font-weight:600;color:rgba(255,255,255,.65);font-size:12.5px}
.sva .lpb .ngsearch{position:relative;z-index:2;margin:0}
.sva .lpb .ngsearch>svg{position:absolute;left:14px;top:50%;transform:translateY(-50%);width:16px;height:16px;fill:#1F6E63;pointer-events:none}
.sva .lpb .ngsearch input{width:100%;font:600 14.5px "Outfit",system-ui,sans-serif;color:#16222E;padding:13px 40px;border:0;border-radius:12px;background:#fff;outline:none;transition:box-shadow .15s}
.sva .lpb .ngsearch input:focus{box-shadow:0 0 0 3px rgba(143,227,201,.45)}
.sva .lpb .ngqc{position:relative;z-index:1;display:flex;gap:7px;margin-top:10px;flex-wrap:wrap}
.sva .lpb .ngqc button{font:700 12px "Outfit",system-ui,sans-serif;color:#fff;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.25);padding:6px 12px;border-radius:999px;cursor:pointer;transition:background .15s}
.sva .lpb .ngqc button:hover{background:rgba(255,255,255,.22)}
.sva .lpb .ngqc button.more{color:#8fe3c9;border-color:rgba(143,227,201,.4)}
.sva .lpb .ngmore{position:relative;overflow:hidden;display:flex;align-items:center;gap:14px;flex-wrap:wrap;margin-top:12px;background:linear-gradient(160deg,#132c34,#1F6E63);border-radius:14px;padding:14px 16px;color:#fff}
.sva .lpb .ngmore::after{content:'';position:absolute;left:-60px;bottom:-80px;width:200px;height:200px;border-radius:50%;background:radial-gradient(circle,rgba(143,227,201,.16),transparent 65%);pointer-events:none}
.sva .lpb .ngmore .tx{position:relative;z-index:1;font:800 14px "Outfit",system-ui,sans-serif}
.sva .lpb .ngmore .tx b{color:#8fe3c9}
.sva .lpb .ngmore .tx span{display:block;font:600 12px "Outfit",system-ui,sans-serif;color:rgba(255,255,255,.65);margin-top:2px}
.sva .lpb .ngmore .btns{position:relative;z-index:1;display:flex;gap:9px;margin-left:auto;flex-wrap:wrap}
.sva .lpb .ngmore .btns a,.sva .lpb .ngmore .btns button{display:inline-flex;align-items:center;gap:7px;font:800 12.5px "Outfit",system-ui,sans-serif;padding:10px 15px;border-radius:999px;text-decoration:none;cursor:pointer;white-space:nowrap;transition:transform .12s,filter .15s}
.sva .lpb .ngmore .btns a:hover,.sva .lpb .ngmore .btns button:hover{transform:translateY(-1px);filter:brightness(.97)}
  ...
  <div class="stk-inner">
    ...
    <div class="stk-cta reveal">
      <a href="{{ 'https://wa.me/'.config('ukv.whatsapp').'?text='.rawurlencode('Hi Beyond Passports, I would like a free document check before I apply.') }}" class="cta-btn" style="width:auto">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style="position:relative;z-index:1"><path d="M.057 24l1.687-6.163a11.867 11.867 0 0 1-1.587-5.946C.16 5.335 5.495 0 12.05 0a11.817 11.817 0 0 1 8.413 3.488 11.824 11.824 0 0 1 3.48 8.414c-.003 6.557-5.338 11.892-11.893 11.892a11.9 11.9 0 0 1-5.688-1.448L.057 24zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884a9.86 9.86 0 0 0 1.51 5.26l-.999 3.648 3.978-1.607zm11.387-5.464c-.074-.124-.272-.198-.57-.347-.297-.149-1.758-.868-2.031-.967-.272-.099-.47-.149-.669.149-.198.297-.768.967-.941 1.165-.173.198-.347.223-.644.074-.297-.149-1.255-.462-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.297-.347.446-.521.151-.172.2-.296.3-.495.099-.198.05-.372-.025-.521-.075-.148-.669-1.611-.916-2.206-.242-.579-.487-.501-.669-.51l-.57-.01c-.198 0-.52.074-.792.372s-1.04 1.016-1.04 2.479 1.065 2.876 1.213 3.074c.149.198 2.095 3.2 5.076 4.487.709.306 1.263.489 1.694.626.712.226 1.36.194 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.695.248-1.29.173-1.414z"/></svg>
  ...
  <div class="section-inner">
    <div class="pt2 reveal">
      ...
      <div class="pt-tm">
        ...
        <div class="pt-row"><img class="pt-av" src="{{ asset('assets/img/team/sarah-whitmore-visa-consultant.jpg?v=2') }}" alt="Sarah, Lead Visa Consultant at Beyond Passports" loading="lazy" width="52" height="52"><div><div class="pt-nm">Sarah</div><div class="pt-rl">Lead Visa Consultant</div><p class="pt-q">I review every refusal letter personally. Most describe something a 30-minute check would have caught.</p></div></div>
        <div class="pt-row"><img class="pt-av" src="{{ asset('assets/img/team/james-whitfield-operations.jpg?v=2') }}" alt="James, Refusal-Recovery Specialist at Beyond Passports" loading="lazy" width="52" height="52"><div><div class="pt-nm">James</div><div class="pt-rl">Refusal-Recovery Specialist</div><p class="pt-q">The refusal letter never tells you the real reason. I find what actually triggered it.</p></div></div>
        <div class="pt-row"><img class="pt-av" src="{{ asset('assets/img/team/zayla-ferreira-appointments.png?v=2') }}" alt="Zayla, Appointments &amp; Client Coordinator at Beyond Passports" loading="lazy" width="52" height="52"><div><div class="pt-nm">Zayla</div><div class="pt-rl">Appointments &amp; Client Coordinator</div><p class="pt-q">I monitor appointment systems daily. Most slots I find never appear on public booking pages.</p></div></div>
      </div>
    </div>
    <div class="reveal" style="margin-top:1.75rem">
      @include('partials.disclaimer-strip', ['wrap' => false])
  ...
  <div class="section-inner">
    <div class="faqwrap">
      <div class="faq-main">
        ...
        <div class="cfaq reveal">
      <div class="fcard open"><div class="fq" onclick="this.closest('.fcard').classList.toggle('open')"><span class="qg">Q</span><span>What does a Schengen visa agent do?</span><span class="pm">+</span></div><div class="fa"><div class="fain">A Schengen visa agent prepares your complete application: documents, cover letter, appointment booking, and a briefing for the embassy visit. You still attend the appointment in person. The agent's job is making sure every document is right before you do. Anyone claiming they can attend on your behalf or guarantee approval is misleading you.</div></div></div>

      <div class="fcard"><div class="fq" onclick="this.closest('.fcard').classList.toggle('open')"><span class="qg">Q</span><span>How much does a Schengen visa agency in the UK charge?</span><span class="pm">+</span></div><div class="fa"><div class="fain">Our service starts from £149 per person. This includes document preparation, cover letter, appointment booking, and our 100% refund promise if your visa is refused. No hidden fees. You see the full price before you pay anything.</div></div></div>

      <div class="fcard"><div class="fq" onclick="this.closest('.fcard').classList.toggle('open')"><span class="qg">Q</span><span>Can you get me a Schengen visa appointment when there are no slots?</span><span class="pm">+</span></div><div class="fa"><div class="fain">We monitor appointment availability at official visa centres across all 29 Schengen countries, rechecked every 3 hours. We regularly secure slots that don't appear on public booking pages. Check current availability in the appointment table above.</div></div></div>

      <div class="fcard"><div class="fq" onclick="this.closest('.fcard').classList.toggle('open')"><span class="qg">Q</span><span>I was refused before. Can you help?</span><span class="pm">+</span></div><div class="fa"><div class="fain">Yes. Refusal recovery is one of our core services. We review your refusal letter, identify what actually triggered it (the letter rarely tells you the real reason), and rebuild your case. If recovery isn't realistic, we tell you honestly rather than take your money.</div></div></div>

      <div class="fcard"><div class="fq" onclick="this.closest('.fcard').classList.toggle('open')"><span class="qg">Q</span><span>Are you a real, registered UK company?</span><span class="pm">+</span></div><div class="fa"><div class="fain">Beyond Passports is registered in England and Wales. ICO registered: ZC197159. UK phone number: +49 1521 3103462. Named team members who respond personally. We're not a WhatsApp-only operation running from abroad. Check our registration yourself.</div></div></div>

      <div class="fcard key"><div class="fq" onclick="this.closest('.fcard').classList.toggle('open')"><span class="qg">Q</span><span>Do I still need to go to the embassy myself?</span><span class="pm">+</span></div><div class="fa"><div class="fain">Yes. No agent in the UK can attend a visa appointment on your behalf. If someone tells you otherwise, they are either lying or operating illegally. Our job is to prepare everything so your visit is smooth and your documents are correct.</div></div></div>

      <div class="fcard"><div class="fq" onclick="this.closest('.fcard').classList.toggle('open')"><span class="qg">Q</span><span>Is there a Schengen visa agent near me?</span><span class="pm">+</span></div><div class="fa"><div class="fain">Beyond Passports is a Schengen visa agency near you wherever you are in the UK: London, Manchester, Birmingham, Edinburgh, Bradford, Leicester, and everywhere in between. Everything is handled over WhatsApp and phone, so you get dedicated Schengen visa agents in the UK working on your case regardless of location. No office visit needed.</div></div></div>

      <div class="fcard"><div class="fq" onclick="this.closest('.fcard').classList.toggle('open')"><span class="qg">Q</span><span>What is the difference between a Schengen visa agent and a travel agent?</span><span class="pm">+</span></div><div class="fa"><div class="fain">A Schengen visa travel agent typically only books flights and hotels. A specialist Schengen visa agent like Beyond Passports handles the full visa application: document preparation, cover letter, appointment booking, and embassy briefing. Some travel agents offer visa assistance as an add-on, but it's rarely their specialism. We do nothing else. Visas are all we do.</div></div></div>

      <div class="fcard"><div class="fq" onclick="this.closest('.fcard').classList.toggle('open')"><span class="qg">Q</span><span>How do I find a trustworthy agency for Schengen visa in the UK?</span><span class="pm">+</span></div><div class="fa"><div class="fain">Look for three things: UK company registration (check Companies House), ICO registration for data protection, and a clear refund policy in writing. Avoid any agency for Schengen visa that guarantees approval. No honest agent can promise that. Beyond Passports is registered in England & Wales, ICO registered (ZC197159), and offers a written 100% service fee refund if your visa is refused.</div></div></div>
        </div>
      </div>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {"@type": "Question", "name": "Are you a real, registered UK company?", "acceptedAnswer": {"@type": "Answer", "text": "Beyond Passports is registered in England and Wales. ICO registered: ZC197159. UK phone number: +49 1521 3103462. Named team members who respond personally."}},
