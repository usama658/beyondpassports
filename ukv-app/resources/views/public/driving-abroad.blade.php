...
<section class="idp-guide" id="how-it-really-works">
  <div class="wrap">
    <div class="sec-head reveal">
      ...
      <h2>An IDP is collected in person, and we make sure you're ready</h2>
    </div>
...
<section class="cta-band">
  <div class="wrap reveal">
    ...
    <div class="row">
      ...
      <a href="https://wa.me/{{ config('ukv.whatsapp') ?: '4915213103462' }}" class="btn btn--glass">@include('partials.wa-glyph')Chat on WhatsApp</a>
