...
<section class="sec tr" id="trust"><div class="wrap">
  ...
  <div class="grid">
    ...
    <div class="lite">
      ...
      <a class="vlink" href="https://find-and-update.company-information.service.gov.uk/company/{{ config('ukv.company_no') }}" target="_blank" rel="noopener"><span class="tick">✓</span><div><h4>Company registration <span class="ext">View on Companies House →</span></h4><p>Beyond Passports Ltd, company no. {{ config('ukv.company_no') }}, on the official Companies House register at gov.uk.</p></div></a>
      <a class="vlink" href="https://ico.org.uk/ESDWebPages/Entry/{{ config('ukv.ico_number') }}" target="_blank" rel="noopener"><span class="tick">✓</span><div><h4>Data handling <span class="ext">Check the ICO register →</span></h4><p>Registered with the Information Commissioner's Office, reg. {{ config('ukv.ico_number') }}. Verify on the public ICO register.</p></div></a>
      <a class="vlink" href="{{ route('checklist.tool') }}"><span class="tick">✓</span><div><h4>Destination requirements <span class="ext">Get your checklist →</span></h4><p>Check the official embassy checklist; we cover every item plus what they don't tell you matters.</p></div></a>
