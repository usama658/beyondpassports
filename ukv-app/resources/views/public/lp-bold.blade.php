...
<section class="pathband" id="paths"><div class="wrap">
  ...
  <div class="sitrow">
    ...
    <a class="sit" data-thx="refusal" href="{{ $wa }}?text={{ rawurlencode('Hi Beyond Passports, I was refused a Schengen visa before. Please review my refusal letter and rebuild my case.') }}"><span class="tx"><span class="st">Previously refused</span><span class="q">"I was refused before"</span><p class="d">A refusal is logged in the shared EU database and stays there for five years. We read your refusal letter, find the reason the consulate actually gave, and rebuild the case from the ground up.</p></span><span class="scta">Fix my refusal ›</span></a>
    ...
    <a class="sit" data-thx="visit" href="{{ $wa }}?text={{ rawurlencode('Hi Beyond Passports, we are visiting family in Europe who have invited us. Please prepare our visit visa and tell our host what to send.') }}"><span class="tx"><span class="st">Visiting friends or family in Europe</span><span class="q">"My brother is in Germany and has invited us"</span><p class="d">This is the case consulates look at hardest, and the one most often refused for weak paperwork on the host's side. We prepare both halves: your evidence here in the UK, and the invitation, accommodation proof and sponsor documents from your host in Europe. We tell your host exactly what to send and in what format.</p></span><span class="scta">Start a family visit ›</span></a>
  </div>
</div></section>
