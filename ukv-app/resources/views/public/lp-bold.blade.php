...
.lpb .ref .stamp{display:inline-block;border:2px solid #f0a58f;color:#f0a58f;font-weight:800;letter-spacing:.1em;font-size:12px;padding:4px 11px;border-radius:5px;transform:rotate(-2deg);margin:0 0 16px;text-transform:uppercase}
...
.lpb .letter .stamp{position:absolute;top:20px;right:-6px;transform:rotate(9deg);border:2.5px solid var(--red);color:var(--red);font-weight:800;letter-spacing:.1em;font-size:15px;padding:5px 14px;border-radius:5px;opacity:.82;text-transform:uppercase}
