...
<section class="pathband" id="paths"><div class="wrap">
  ...
  <div class="sitrow">
    ...
    <a class="sit" data-thx="visit" href="{{ $wa }}?text={{ rawurlencode('Hi Beyond Passports, we are visiting family in Europe who have invited us. Please prepare our visit visa and tell our host what to send.') }}"><span class="tx"><span class="st">Visiting friends or family in Europe?</span><span class="q">"My brother has invited us"</span><p class="d">We prepare both halves: your evidence here in the UK, and the invitation, accommodation proof and sponsor documents from your host in Europe. We tell your host exactly what to send and in what format.</p></span><span class="scta">Start a family visit ›</span></a>
  </div>
</div></section>
