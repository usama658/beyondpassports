...
.lpb .hgrid{display:grid;grid-template-columns:1.54fr .97fr;gap:40px;align-items:center}
...
<section class="hero" id="top"><div class="wrap"><div class="hgrid">
  <div class="hleft">
    ...
    <h2 class="hhead">Schengen visa specialists. <span class="hl-r">Fast appointments, error-free applications.</span></h2>
...
<section class="pathband" id="paths"><div class="wrap">
  ...
  <div class="sitrow">
    ...
    <a class="sit" data-thx="refusal" href="{{ $wa }}?text={{ rawurlencode('Hi Beyond Passports, I was refused a Schengen visa before. Please review my refusal letter and rebuild my case.') }}"><span class="tx"><span class="st">Previously refused?</span><span class="q">"I was refused before"</span><p class="d">A refusal stays in the shared EU database for 5 years. We read your refusal letter, find the reason the consulate gave, and rebuild the case from the ground up.</p></span><span class="scta">Fix my refusal ›</span></a>
    <a class="sit" data-thx="multicountry" href="{{ $wa }}?text={{ rawurlencode('Hi Beyond Passports, my trip covers more than one Schengen country. Which consulate should I apply through? My rough plan is: ') }}"><span class="tx"><span class="st">Visiting more than one country?</span><span class="q">"Which embassy do I even apply to?"</span><p class="d">Pick the wrong consulate and you can be refused before anyone reads your file. The rule is the country where you spend the most days, and if it is a tie, your first entry. We work out the right one for you and, where it fits, get one visa that covers both trips.</p></span><span class="scta">Tell me which country to apply through ›</span></a>
    <a class="sit" data-thx="student" href="{{ $wa }}?text={{ rawurlencode("Hi Beyond Passports, I'm on a UK student visa and not working. Can you build my Schengen file around my funding and sponsor? My course and sponsor details are: ") }}"><span class="tx"><span class="st">Student, not working?</span><span class="q">"Will they think I cannot support myself?"</span><p class="d">A student file is built differently, not weakly. Enrolment letter, term dates, and clear proof of who funds the trip. If a sponsor supports you, we evidence both the relationship and the money together. That is what a strong student case looks like.</p></span><span class="scta">Build my student file ›</span></a>
  </div>
</div></section>
