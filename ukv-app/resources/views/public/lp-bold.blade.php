...
<section class="pathband" id="paths"><div class="wrap">
  ...
  <div class="sitrow">
    ...
    <a class="sit" data-thx="family" href="{{ $wa }}?text={{ rawurlencode("Hi, we're applying for Schengen visas together as a couple/family. Can you prepare our applications together so nothing gets missed?") }}"><span class="tx"><span class="st">First time? Visiting family or friends?</span><span class="q">"We're applying together"</span><p class="d">We prepare every file together and check each one against the others so no two applications contradict. Group of three or more: our fee per person drops.</p></span><span class="scta">Get the group price ›</span></a>
    ...
    <a class="sit" data-thx="agent" href="{{ $wa }}?text={{ rawurlencode('Hi Beyond Passports, this is my first Schengen visa. Please prepare my tourist visa documents and handle the appointment for me.') }}"><span class="tx"><span class="st">First time applicant?</span><span class="q">"I have never done this before"</span><p class="d">We prepare your complete document file: bank statements, employment letter, itinerary, travel insurance, accommodation. You submit at the visa centre. We handle everything before that day.</p></span><span class="scta">Start my tourist visa ›</span></a>
    <a class="sit" data-thx="visit" href="{{ $wa }}?text={{ rawurlencode('Hi Beyond Passports, we are visiting family in Europe who have invited us. Please prepare our visit visa and tell our host what to send.') }}"><span class="tx"><span class="st">Visiting friends or family in Europe?</span><span class="q">"My brother has invited us"</span><p class="d">This is one of the cases most often refused for weak paperwork. We prepare both halves: your evidence here in the UK, and the invitation, accommodation proof and sponsor documents from your host in Europe.</p></span><span class="scta">Start a family visit ›</span></a>
  </div>
</div></section>
...
<section class="sec tr" id="trust"><div class="wrap">
  <div class="thead">
    ...
    <h2 class="h2" style="margin:0 auto;max-width:30ch">Here's what happens when you message Schengen visa consultancy UK.</h2>
  </div>
  <div class="grid">
    <div class="dark">
