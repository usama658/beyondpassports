...
<section class="pathband" id="paths"><div class="wrap">
  ...
  <div class="sitrow">
    ...
    <a class="sit" data-thx="refusal" href="{{ $wa }}?text={{ rawurlencode('Hi Beyond Passports, I was refused a Schengen visa before. Please review my refusal letter and rebuild my case.') }}"><span class="tx"><span class="st">Previously refused</span><span class="q">"I was refused before"</span><p class="d">A refusal is logged in the shared EU database and stays there for 5 years. We read your refusal letter, find the reason the consulate gave, and rebuild the case from the ground up.</p></span><span class="scta">Fix my refusal ›</span></a>
