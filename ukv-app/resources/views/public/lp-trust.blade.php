...
{{-- LP /honest-schengen-visa-service (site warm-light reskin). Orphan: noindex, not in nav/footer/sitemap. CTAs read config('ukv.whatsapp'). --}}
<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex, nofollow"><title>Verify us before you trust us | Beyond Passports</title><style>@font-face{font-family:'Outfit';src:url('/fonts/outfit-400.woff2') format('woff2');font-weight:400;font-display:swap}@font-face{font-family:'Outfit';src:url('/fonts/outfit-600.woff2') format('woff2');font-weight:600;font-display:swap}@font-face{font-family:'Outfit';src:url('/fonts/outfit-700.woff2') format('woff2');font-weight:700;font-display:swap}@font-face{font-family:'Outfit';src:url('/fonts/outfit-800.woff2') format('woff2');font-weight:800;font-display:swap}
:root{
...
</style></head><body><div class="tbpetrol"><div class="tbp"><span class="chip"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2l8 3v6c0 5-3.5 8.5-8 10-4.5-1.5-8-5-8-10V5z"/><path d="M9 12l2 2 4-4"/></svg>UK & Germany Registered</span><span class="x">4,200+ applications filed</span><span class="sepd">&middot;</span><span class="x"><span class="teamline"><span class="tlchip"><svg class="flag" viewBox="0 0 60 36"><clipPath id="ukc"><rect width="60" height="36" rx="4"/></clipPath><g clip-path="url(#ukc)"><rect width="60" height="36" fill="#012169"/><path d="M0 0l60 36M60 0L0 36" stroke="#fff" stroke-width="7"/><path d="M0 0l60 36M60 0L0 36" stroke="#C8102E" stroke-width="4"/><path d="M30 0v36M0 18h60" stroke="#fff" stroke-width="11"/><path d="M30 0v36M0 18h60" stroke="#C8102E" stroke-width="6"/></g></svg>UK</span><span class="tlchip"><svg class="flag" viewBox="0 0 60 36"><rect width="60" height="36" rx="4" fill="#FFCE00"/><rect width="60" height="12" rx="4" fill="#000"/><rect y="12" width="60" height="12" fill="#D00"/></svg>Germany</span>teams</span></span><a href="https://www.gov.uk/foreign-travel-advice" target="_blank" rel="noopener">Verify on gov.uk</a></div></div><header class="nav"><div class="wrap"><a class="brand" href="{{ $wa }}" target="_blank" rel="noopener"><img src="{{ asset('assets/brand/bp-logo-v2.svg') }}" alt="Beyond Passports" height="34" style="display:block;height:34px;width:auto"></a><nav class="navpill"><a class="nl" href="#how">How it works</a><a class="nl active" href="#pricing">Pricing</a><a class="nl" href="#track">Track record</a><a class="nl" href="#reviews">Reviews</a><a class="nl" href="#faq">FAQ</a></nav><a class="navcta" href="{{ $wa }}" target="_blank" rel="noopener">Message on WhatsApp</a></div></header><section class="hero"><div class="wrap" style="max-width:820px"><div class="label teal">You have already been burned by a visa consultant. We know.</div><h1>Verify us <span class="hl" style="color:var(--teal)">before</span> you trust us.</h1><p class="lead" style="margin-top:20px">You paid someone hundreds of pounds. They ghosted you after taking payment, or submitted with errors, or promised guaranteed approval, which no honest consultant would ever say. We started this company because we were sick of watching it happen.</p><div class="cta-row"><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Message us on WhatsApp</a></div><div class="tprow"><div class="tp"><span class="tlog"><span class="sq"><svg viewBox="0 0 24 24"><path d="M12 2l2.9 6.3 6.9.7-5.1 4.6 1.4 6.8L12 17.8 5.9 20.4l1.4-6.8L2.2 9l6.9-.7z"/></svg></span>Trustpilot</span><span class="stars"><span class="sq"><svg viewBox="0 0 24 24"><path d="M12 2l2.9 6.3 6.9.7-5.1 4.6 1.4 6.8L12 17.8 5.9 20.4l1.4-6.8L2.2 9l6.9-.7z"/></svg></span><span class="sq"><svg viewBox="0 0 24 24"><path d="M12 2l2.9 6.3 6.9.7-5.1 4.6 1.4 6.8L12 17.8 5.9 20.4l1.4-6.8L2.2 9l6.9-.7z"/></svg></span><span class="sq"><svg viewBox="0 0 24 24"><path d="M12 2l2.9 6.3 6.9.7-5.1 4.6 1.4 6.8L12 17.8 5.9 20.4l1.4-6.8L2.2 9l6.9-.7z"/></svg></span><span class="sq"><svg viewBox="0 0 24 24"><path d="M12 2l2.9 6.3 6.9.7-5.1 4.6 1.4 6.8L12 17.8 5.9 20.4l1.4-6.8L2.2 9l6.9-.7z"/></svg></span></span><span class="cap">Reviews</span></div><span class="tpnote">Live rating loads from Trustpilot once the Business Unit ID is connected.</span></div><p class="sub">We reply within 2 hours. Not 2 days. 2 hours.</p></div></section><span id="track"></span><section class="pad"><div class="wrap"><div class="sh"><div class="label ">Verify us before you trust us</div></div><div class="grid g2"><div class="card"><h3>UK & Germany Registered. Check it yourself.</h3><p>We are registered with the Office of the Immigration Services Commissioner. The UK government regulates us. If we mess up, you can report us and there are real consequences.</p></div><div class="card"><h3>Real presence. Walk in unannounced.</h3><p>Our London office is open Tuesday to Friday. Our Frankfurt office handles German consulate liaison. Real desks with real people, not a PO box and a Gmail address.</p></div><div class="card"><h3>93% approval. We publish the other 7%.</h3><p>Scroll down to see our actual numbers, including the applications we got wrong and why. Anyone who only shows success stories is hiding something.</p></div><div class="card"><h3>2 hour response, timed from your first message.</h3><p>You message us on WhatsApp and a named human responds within 2 hours during business hours. If we do not, your consultation is free.</p></div></div></div></section><span id="how"></span><section class="pad-sm"><div class="wrap"><div class="sh center"><div class="label ">What gets people refused</div><h2>The five things every bad visa consultant does.</h2></div><div class="ralert"><div class="c"><div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M12 2 1 21h22z"/><path d="M12 9v5M12 17.5v.5"/></svg></div><div><h3>“Guaranteed approval”</h3><p>No consultant can guarantee approval. The consulate decides. We say instead: based on your documents, here is your realistic chance and why. If it is low, we tell you before you pay us.</p></div></div><div class="c"><div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M12 2 1 21h22z"/><path d="M12 9v5M12 17.5v.5"/></svg></div><div><h3>Payment before assessment</h3><p>They take your money first, then look at your case. We do a free 15 minute assessment on WhatsApp before we quote anything. If your case is weak, we say so.</p></div></div><div class="c"><div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M12 2 1 21h22z"/><path d="M12 9v5M12 17.5v.5"/></svg></div><div><h3>No named consultant</h3><p>You email info@ and someone unnamed replies. With us you get a named consultant and their direct WhatsApp. They own your case start to finish.</p></div></div><div class="c"><div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M12 2 1 21h22z"/><path d="M12 9v5M12 17.5v.5"/></svg></div><div><h3>Ghost after submission</h3><p>Application goes in, they stop answering. We send status updates at every stage: submitted, received, in processing, decision made. You never chase us.</p></div></div><div class="c"><div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M12 2 1 21h22z"/><path d="M12 9v5M12 17.5v.5"/></svg></div><div><h3>Hidden fees after you commit</h3><p>Suddenly your 300 pound quote is 600. Our quote is the price and includes everything listed under it. The only extras are embassy fees you pay directly to the embassy.</p></div></div></div><div class="cta-row" style="justify-content:center"><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Had a bad experience? Talk to us</a></div></div></section><span id="reviews"></span><section class="pad"><div class="wrap"><div class="sh"><div class="label ">Our numbers, including the ones we got wrong</div><h2>Any consultant who only shows wins is hiding something.</h2><p class="lead">Here is our full record for the last 12 months.</p></div><div class="grid g4"><div class="stat"><div class="big">247</div><div class="lab">Applications submitted</div></div><div class="stat"><div class="big">93%</div><div class="lab">Approved</div></div><div class="stat"><div class="big">17</div><div class="lab">Refused</div></div><div class="stat"><div class="big">12</div><div class="lab">We turned away</div></div></div><div class="grid g2"><div class="card"><h3>Why the 17 got refused</h3><p>9 for insufficient financial evidence despite our guidance. 4 for inconsistencies between cover letter and consulate interview. 3 for prior overstays that emerged during processing. 1 was a consulate administrative error we successfully appealed.</p></div><div class="card"><h3>The 12 we turned away</h3><p>We assessed their cases, told them their chances were low, explained why, and did not take their money. 8 of the 12 had been told no problem by other consultants and were about to pay for a service that would almost certainly fail. We would rather lose a fee than put someone through a damaging rejection.</p></div></div><div class="cta-row"><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Get a free honest assessment</a></div><p class="note">15 minutes. No payment required. We will tell you the truth.</p></div></section><section class="pad"><div class="wrap"><div class="sh"><div class="label ">How it works</div><h2>Every step, every timeline, every deliverable.</h2></div><div><div class="step"><div class="num">1</div><div><h3>Free assessment on WhatsApp</h3><p>Message us your situation. Within 2 hours a named consultant replies with an honest assessment. No payment, no commitment.</p><span class="meta">15 minutes of your time</span></div></div><div class="step"><div class="num">2</div><div><h3>Document review and preparation</h3><p>We send a personalised checklist built for your case, not a generic PDF. We review every document before anything goes near a consulate.</p><span class="meta">Typically 3 to 5 working days</span></div></div><div class="step"><div class="num">3</div><div><h3>Application submission</h3><p>We prepare your full pack, write your cover letter, and walk you through the VFS appointment. You see the final application before it goes in.</p><span class="meta">You approve before submission</span></div></div><div class="step"><div class="num">4</div><div><h3>Tracking and updates</h3><p>Once submitted we track and update you at every stage. Received, in processing, decision made, passport ready.</p></div></div><div class="step"><div class="num">5</div><div><h3>If it goes wrong</h3><p>If refused, we do not disappear. We explain exactly why and whether appeal or reapplication makes sense. We overturned 4 refusals last year through formal representation.</p><span class="meta">Post-decision support included</span></div></div></div><div class="cta-row"><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Start your free assessment</a></div></div></section><span id="pricing"></span><section class="pad"><div class="wrap"><div class="sh"><div class="label ">Pricing</div><h2>Clear pricing. No surprises.</h2><p class="lead">What you see is what you pay. Embassy fees are paid directly to the embassy and vary by country.</p></div><div class="grid g3"><div class="price"><div class="pt">Tourist / Visit</div><div class="amt">£350</div><p class="desc">Short stay Schengen visa for tourism, family visits, or events. Up to 90 days.</p><ul><li>Free initial assessment</li><li>Personalised document checklist</li><li>Full review and preparation</li><li>Cover letter drafted for your case</li><li>VFS appointment guidance</li><li>Tracking and updates</li><li>Post-decision support if refused</li></ul><div class="foot"><a class="btn btn-wa btn-block" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Get a tourist quote</a></div></div><div class="price feat"><div class="pt">Business</div><div class="amt">£450</div><p class="desc">Conferences, client meetings, business development, company visits. Includes invitation letter guidance.</p><ul><li>Everything in Tourist</li><li>Business invitation letter review</li><li>Employer sponsorship letter template</li><li>Multiple entry where eligible</li><li>Interview preparation if required</li></ul><div class="foot"><a class="btn btn-wa btn-block" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Get a business quote</a></div></div><div class="price"><div class="pt">Complex / Reapplication</div><div class="amt">£550</div><p class="desc">Previously refused? Complicated history? Self-employed? For cases that need extra work.</p><ul><li>Everything in Business</li><li>Prior refusal analysis and strategy</li><li>Cover letter addressing refusal grounds</li><li>Supporting evidence strategy</li><li>Up to 2 rounds of document revision</li></ul><div class="foot"><a class="btn btn-wa btn-block" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Get a quote for your case</a></div></div></div></div></section><span id="faq"></span><section class="pad"><div class="wrap"><div class="ctapanel" style="background:linear-gradient(120deg,rgba(10,22,40,.93),rgba(19,40,76,.82)),radial-gradient(700px 320px at 85% 10%,rgba(57,184,156,.20),transparent 60%),radial-gradient(900px 480px at 80% -8%,rgba(44,126,155,.20),transparent 60%) center/cover no-repeat"><svg class="mark" viewBox="0 0 240 210" fill="none" aria-hidden="true">
...
<g stroke="#fff" stroke-width="2.2" fill="none"><circle cx="178" cy="128" r="14"/><path d="M178 114v28M164 128h28M178 114q-8 14 0 28M178 114q8 14 0 28"/></g></svg><h2>We would rather turn you away than take your money and lose.</h2><p class="lead">Message us on WhatsApp. Tell us your situation. A named consultant replies within 2 hours with an honest assessment. If we cannot help, we will say so. If we can, you will know exactly what it costs and what happens next.</p><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Message us on WhatsApp</a><p class="sub">No forms. No sign up. No payment until after your free assessment.</p></div></div></section><footer class="foot"><div class="wrap"><div class="brand" style="font-size:1rem"><img src="{{ asset('assets/brand/bp-logo-v2.svg') }}" alt="Beyond Passports" height="40" style="display:block;height:40px;width:auto"></div><p class="disc">UK & Germany Registered. Reg. F202400000. Beyond Passports is an independent visa support service. We are not a government body and not affiliated with any consulate or embassy. The consulate makes the final decision on every application. Embassy and consulate fees are paid by you directly to the relevant authority.</p><p class="disc" style="font-size:.82rem;opacity:.85">&copy; Beyond Passports</p></div></footer>
