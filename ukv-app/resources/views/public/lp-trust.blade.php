...
<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex, nofollow"><link rel="icon" href="{{ asset('assets/brand/favicon.svg?v=2') }}" type="image/svg+xml"><link rel="icon" href="{{ asset('assets/brand/favicon.ico') }}" sizes="any"><link rel="apple-touch-icon" href="{{ asset('assets/brand/apple-touch-icon.png') }}"><meta name="theme-color" content="#155E7A"><title>Verify us before you trust us | Beyond Passports</title><style>@font-face{font-family:'Outfit';src:url('/fonts/outfit-400.woff2') format('woff2');font-weight:400;font-display:swap}@font-face{font-family:'Outfit';src:url('/fonts/outfit-600.woff2') format('woff2');font-weight:600;font-display:swap}@font-face{font-family:'Outfit';src:url('/fonts/outfit-700.woff2') format('woff2');font-weight:700;font-display:swap}@font-face{font-family:'Outfit';src:url('/fonts/outfit-800.woff2') format('woff2');font-weight:800;font-display:swap}
:root{
...
<g stroke="#fff" stroke-width="2.2" fill="none"><circle cx="178" cy="128" r="14"/><path d="M178 114v28M164 128h28M178 114q-8 14 0 28M178 114q8 14 0 28"/></g></svg><h2>We would rather turn you away than take your money and lose.</h2><p class="lead">Message us on WhatsApp. Tell us your situation. A named consultant replies within {{ App\Support\SiteStats::responseSla() }} with an honest assessment. If we cannot help, we will say so. If we can, you will know exactly what it costs and what happens next.</p><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Message us on WhatsApp</a><p class="sub">No forms. No sign up. No payment until after your free assessment.</p></div></div></section>@include('partials.lp-footer')
