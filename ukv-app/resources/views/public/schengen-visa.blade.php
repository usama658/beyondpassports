...
@php
  ...
  $serviceLd = [
    ...
    'description' => 'Independent UK and Europe consultancy that prepares, checks and submits Schengen visa applications for UK residents. Service fee separate from the government fee. Not a government website.',
...
<section class="sgc-hero"><div class="wrap"><div class="sgc-hero-grid">
  <div class="reveal">
    ...
    <p class="lede">An independent service, <x-reg-verify>registered in the UK and Europe</x-reg-verify>, that prepares, checks and submits your application, catching the small mistakes that get people refused. We are with you from the first eligibility check to the appointment door.</p>
  </div>
