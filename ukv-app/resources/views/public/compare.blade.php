...
<section class="cta-band"><div class="wrap reveal">
  ...
  <div class="row"><a href="{{ App\Support\SiteStats::chatUrl() }}" target="_blank" rel="noopener" class="btn">Check eligibility →</a> @include('partials.consult-cta')<a href="https://wa.me/{{ config('ukv.whatsapp') ?: '440000000000' }}" class="btn btn--wa">@include('partials.wa-glyph')Ask us first on WhatsApp</a></div>
</div></section>
