...
@php
  $fcWa = 'https://wa.me/'.(config('ukv.whatsapp') ?: '4915213103462').'?text='.rawurlencode('Hi Beyond Passports, I found my nearest centre. Can you check my eligibility and book my Schengen appointment?');
@endphp
