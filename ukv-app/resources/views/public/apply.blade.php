    ...
    <div class="outcome" id="outcome-standard" role="region" aria-label="Standard service result" aria-hidden="true" tabindex="-1">
      <div class="panel">
        ...
        <div class="pbody">
          ...
          @include('partials.trustpilot-cta', ['margin' => '16px 0 0'])
        </div>
      </div>
    </div>
...
<div class="cbm" id="cb-modal" role="dialog" aria-modal="true" aria-labelledby="cbm-title" aria-hidden="true">
  <div class="box">
    ...
    <div class="acts">
      <a class="btn" href="https://wa.me/{{ config('ukv.whatsapp') ?: '4915213103462' }}">@include('partials.wa-glyph')WhatsApp us</a>
...
<section class="cta-band"><div class="wrap reveal">
  ...
  <p style="max-width:52ch;color:#cdd9e1">A <x-reg-verify>England and Wales registered</x-reg-verify> service reviews every case before anything is submitted. We're an independent service, not a government website, and we'll always tell you honestly what you need.</p>
  <div class="row"><a href="{{ url('/') }}#how" class="btn btn--ghost" style="color:#fff;border-color:#cdd9e1">How it works</a><a href="https://wa.me/{{ config('ukv.whatsapp') ?: '4915213103462' }}" class="btn btn--glass">@include('partials.wa-glyph')Chat on WhatsApp</a></div>
