...
<div class="cbm" id="cb-modal" role="dialog" aria-modal="true" aria-labelledby="cbm-title" aria-hidden="true">
  <div class="box">
    ...
    <div class="acts">
      <a class="btn" href="https://wa.me/{{ config('ukv.whatsapp') ?: '447462230788' }}">@include('partials.wa-glyph')WhatsApp us</a>
...
<section class="cta-band"><div class="wrap reveal">
  ...
  <div class="row"><a href="{{ url('/') }}#how" class="btn btn--ghost" style="color:#fff;border-color:#cdd9e1">How it works</a><a href="https://wa.me/{{ config('ukv.whatsapp') ?: '447462230788' }}" class="btn btn--glass">@include('partials.wa-glyph')Chat on WhatsApp</a></div>
