...
<main id="main">
  ...
  <section class="cta-band"><div class="wrap reveal">
    ...
    <p style="max-width:52ch;color:#cdd9e1">Start your application and our <x-reg-verify>UK &amp; Europe registered</x-reg-verify> service will confirm your exact requirements and check every document before anything is submitted.</p>
    <div class="row">
