@php
    ...
    $waNum        = config('ukv.whatsapp') ?: '447462230788';
...
<main id="main">
  ...
  <section class="cta-band"><div class="wrap reveal">
    ...
    <div class="row">
      ...
      <a href="https://wa.me/{{ config('ukv.whatsapp') ?: '447462230788' }}?text={{ rawurlencode('Hi Beyond Passports, here is my document checklist, can you check it?') }}" class="btn btn--glass">@include('partials.wa-glyph')Chat on WhatsApp</a>
