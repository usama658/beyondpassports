...
<section style="padding:40px 0">
  <div class="wrap">
    <div class="help-band reveal">
      ...
      <div class="links">
        <a href="tel:{{ config('ukv.phone_e164') ?: '+4915213103462' }}" class="btn btn--ghost" style="padding:13px 22px">@include('partials.call-glyph')Call UK</a>
        ...
        <a href="https://wa.me/{{ config('ukv.whatsapp') ?: '4915213103462' }}" class="btn btn--ghost" style="padding:13px 22px">@include('partials.wa-glyph')WhatsApp</a>
