...
<section class="cta-band"><div class="wrap reveal">
  ...
  <div class="row"><a href="{{ App\Support\SiteStats::chatUrl('Hi Beyond Passports, I would like to start my Schengen visa.') }}" target="_blank" rel="noopener" class="btn">Check eligibility →</a> @include('partials.consult-cta')<a href="https://wa.me/{{ config('ukv.whatsapp') ?: '4915213103462' }}?text={{ rawurlencode('Hi Beyond Passports, I would like to start my Schengen visa.') }}" class="btn btn--glass">@include('partials.wa-glyph')Chat on WhatsApp</a></div>
