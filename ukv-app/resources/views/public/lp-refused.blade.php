...
{{-- LP /schengen-visa-refused (site warm-light reskin). Orphan: noindex, not in nav/footer/sitemap. CTAs read config('ukv.whatsapp'). --}}
<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex, nofollow"><title>The reason they gave you is probably not the real reason | Beyond Passports</title><style>@font-face{font-family:'Outfit';src:url('/fonts/outfit-400.woff2') format('woff2');font-weight:400;font-display:swap}@font-face{font-family:'Outfit';src:url('/fonts/outfit-600.woff2') format('woff2');font-weight:600;font-display:swap}@font-face{font-family:'Outfit';src:url('/fonts/outfit-700.woff2') format('woff2');font-weight:700;font-display:swap}@font-face{font-family:'Outfit';src:url('/fonts/outfit-800.woff2') format('woff2');font-weight:800;font-display:swap}
:root{
...
</style></head><body><div class="tbpetrol"><div class="tbp"><span class="chip"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2l8 3v6c0 5-3.5 8.5-8 10-4.5-1.5-8-5-8-10V5z"/><path d="M9 12l2 2 4-4"/></svg>UK & Germany Registered</span><span class="x">4,200+ applications filed</span><span class="sepd">&middot;</span><span class="x"><span class="teamline"><span class="tlchip"><svg class="flag" viewBox="0 0 60 36"><clipPath id="ukc"><rect width="60" height="36" rx="4"/></clipPath><g clip-path="url(#ukc)"><rect width="60" height="36" fill="#012169"/><path d="M0 0l60 36M60 0L0 36" stroke="#fff" stroke-width="7"/><path d="M0 0l60 36M60 0L0 36" stroke="#C8102E" stroke-width="4"/><path d="M30 0v36M0 18h60" stroke="#fff" stroke-width="11"/><path d="M30 0v36M0 18h60" stroke="#C8102E" stroke-width="6"/></g></svg>UK</span><span class="tlchip"><svg class="flag" viewBox="0 0 60 36"><rect width="60" height="36" rx="4" fill="#FFCE00"/><rect width="60" height="12" rx="4" fill="#000"/><rect y="12" width="60" height="12" fill="#D00"/></svg>Germany</span>teams</span></span><a href="https://www.gov.uk/foreign-travel-advice" target="_blank" rel="noopener">Verify on gov.uk</a></div></div><header class="nav"><div class="wrap"><a class="brand" href="{{ $wa }}" target="_blank" rel="noopener"><img src="{{ asset('assets/brand/bp-logo-v2.svg') }}" alt="Beyond Passports" height="34" style="display:block;height:34px;width:auto"></a><nav class="navpill"><a class="nl" href="#how">How it works</a><a class="nl active" href="#pricing">Pricing</a><a class="nl" href="#track">Track record</a><a class="nl" href="#reviews">Reviews</a><a class="nl" href="#faq">FAQ</a></nav><a class="navcta" href="{{ $wa }}" target="_blank" rel="noopener">Message on WhatsApp</a></div></header><section class="hero"><div class="wrap"><div class="hsplit"><div><div class="label ">For UK residents refused a Schengen visa</div><h1 style="font-size:clamp(1.9rem,4vw,2.8rem)">You were refused. <span class="hl">The reason they gave you is probably not the real reason.</span></h1><p class="lead" style="margin-top:18px">That letter uses careful, rehearsed language. Every consulate does. The actual weakness is buried. Reapply fixing only what the letter says and you will most likely be refused again, with a worse record.</p><div class="cta-row"><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Send us your refusal letter on WhatsApp</a></div><div class="tprow"><div class="tp"><span class="tlog"><span class="sq"><svg viewBox="0 0 24 24"><path d="M12 2l2.9 6.3 6.9.7-5.1 4.6 1.4 6.8L12 17.8 5.9 20.4l1.4-6.8L2.2 9l6.9-.7z"/></svg></span>Trustpilot</span><span class="stars"><span class="sq"><svg viewBox="0 0 24 24"><path d="M12 2l2.9 6.3 6.9.7-5.1 4.6 1.4 6.8L12 17.8 5.9 20.4l1.4-6.8L2.2 9l6.9-.7z"/></svg></span><span class="sq"><svg viewBox="0 0 24 24"><path d="M12 2l2.9 6.3 6.9.7-5.1 4.6 1.4 6.8L12 17.8 5.9 20.4l1.4-6.8L2.2 9l6.9-.7z"/></svg></span><span class="sq"><svg viewBox="0 0 24 24"><path d="M12 2l2.9 6.3 6.9.7-5.1 4.6 1.4 6.8L12 17.8 5.9 20.4l1.4-6.8L2.2 9l6.9-.7z"/></svg></span><span class="sq"><svg viewBox="0 0 24 24"><path d="M12 2l2.9 6.3 6.9.7-5.1 4.6 1.4 6.8L12 17.8 5.9 20.4l1.4-6.8L2.2 9l6.9-.7z"/></svg></span></span><span class="cap">Reviews</span></div><span class="tpnote">Live rating loads from Trustpilot once the Business Unit ID is connected.</span></div><p class="sub">We read refusal letters every day. We will tell you what yours actually means.</p></div><div><div class="vboard"><div class="phead"><span class="dot live"></span><b>Reapplication appointment slots we can access right now</b><small>Updated daily</small></div><div class="vbwrap"><div class="vbtrack"><div class="vbset"><div class="prow"><span class="pco">Germany</span><span class="pd fast">within 1 week</span><a class="pchk" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Check</a></div><div class="prow"><span class="pco">Spain</span><span class="pd go">within 1 week</span><a class="pchk" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Check</a></div><div class="prow"><span class="pco">France</span><span class="pd mid">within 2 weeks</span><a class="pchk" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Check</a></div><div class="prow"><span class="pco">Netherlands</span><span class="pd mid">within 2 weeks</span><a class="pchk" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Check</a></div><div class="prow"><span class="pco">Italy<span class="bn">limited</span></span><span class="pd slow">3 to 4 weeks</span><a class="pchk" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Check</a></div></div><div class="vbset" aria-hidden="true"><div class="prow"><span class="pco">Germany</span><span class="pd fast">within 1 week</span><a class="pchk" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Check</a></div><div class="prow"><span class="pco">Spain</span><span class="pd go">within 1 week</span><a class="pchk" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Check</a></div><div class="prow"><span class="pco">France</span><span class="pd mid">within 2 weeks</span><a class="pchk" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Check</a></div><div class="prow"><span class="pco">Netherlands</span><span class="pd mid">within 2 weeks</span><a class="pchk" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Check</a></div><div class="prow"><span class="pco">Italy<span class="bn">limited</span></span><span class="pd slow">3 to 4 weeks</span><a class="pchk" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Check</a></div></div></div></div></div></div></div></div></section><span id="how"></span><section class="pad"><div class="wrap"><div class="sh"><div class="label ">The real problem</div><h2>A second refusal is <span class="hl">worse</span> than the first.</h2><p class="lead">You want to fix the thing they flagged and try again quickly. This is the most dangerous moment in your visa history.</p></div><div class="grid g3"><div class="card"><h3>A pattern forms</h3><p>Consulates share records across the Schengen zone. A single rejected application becomes evidence of a profile they do not trust. The third attempt gets even harder.</p></div><div class="card"><h3>People change one detail</h3><p>Most who come to us after two refusals changed the one thing the letter mentioned. Added a bank statement. New cover letter. Different hotel.</p></div><div class="card"><h3>It was never the real problem</h3><p>It was not enough, because the stated reason was never the actual weakness. The fix has to address what the officer really responded to.</p></div></div></div></section><section class="pad"><div class="wrap"><div class="sh"><div class="label ">Refusal decoder</div><h2>What the letter says vs what it actually means.</h2><p class="lead">Consulates use standardised language from a fixed set of reasons. Here is what three of the most common ones actually signal.</p></div><div class="grid g3"><div class="card"><div class="n">Coded reason 1</div><h3>“Purpose and conditions of the stay were not reliable”</h3><p>Your trip story did not make sense to the officer. Itinerary too ambitious for the dates, accommodation that did not match the stated purpose. Fixable, but not by adding more paper. The whole narrative needs rebuilding.</p></div><div class="card"><div class="n">Coded reason 2</div><h3>“Intention to leave could not be ascertained”</h3><p>The officer thinks you will not come back. This is not about your bank balance. It is about your ties to the UK: employment, property, family, obligations. The fix is structural, not financial.</p></div><div class="card"><div class="n">Coded reason 3</div><h3>“Justification for the stay was not provided”</h3><p>Your documents and your stated reason did not connect. A thick file is not a strong file. Sometimes it is just a confused one.</p></div></div></div></section><section class="pad-sm"><div class="wrap"><div class="sh center"><div class="label ">How it works</div><h2>Four steps. No guesswork.</h2></div><div class="htw"><div class="row"><div class="num">1</div><div class="card left"><h3>Refusal analysis</h3><p>You send your refusal letter and original documents. We read the stated reasons, cross reference them against your actual file, and identify the real weaknesses. Not what the letter says, what the officer responded to.</p><div class="foot"><a class="link-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Send your letter<span class="ar">&rarr;</span></a></div></div></div><div class="row"><div class="num">2</div><div class="card right"><h3>Honest assessment</h3><p>We tell you one of three things: ready to reapply, wait three to six months and strengthen first, or this is not the right route. We tell some people to wait. That conversation is not easy but it is necessary.</p><div class="foot"><a class="link-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Get an honest read<span class="ar">&rarr;</span></a></div></div></div><div class="row"><div class="num">3</div><div class="card left"><h3>Application rebuild</h3><p>If you are ready, we reconstruct from the ground up. New supporting documents, new narrative structure, every piece chosen to address the identified weakness, not the stated reason.</p><div class="foot"><a class="link-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Start a rebuild<span class="ar">&rarr;</span></a></div></div></div><div class="row"><div class="num">4</div><div class="card right"><h3>Submission and tracking</h3><p>We handle appointment booking, document formatting, and submission. You get updates on WhatsApp as things progress. No chasing, no wondering.</p><div class="foot"><a class="link-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Track on WhatsApp<span class="ar">&rarr;</span></a></div></div></div></div></div></section><span id="track"></span><section class="pad"><div class="wrap"><div class="trpanel" style="background-image:linear-gradient(90deg,rgba(8,17,33,.95),rgba(8,17,33,.82) 55%,rgba(8,17,33,.62)),radial-gradient(900px 480px at 80% -8%,rgba(44,126,155,.20),transparent 60%);background-size:cover;background-position:center"><div class="label teal">Track record</div><h2 style="max-width:22ch;margin:0 auto">92% approval on reapplications <span class="hl">after refusal</span>.</h2><p class="lead" style="margin:14px auto 0">That number is real but it needs context. It is high because of the 30% we turn away. We do not take cases we expect to lose.</p><div class="trrow"><div class="s"><div class="num">92%</div><div class="l">Approval on post-refusal applications</div></div><div class="s"><div class="num">2,300+</div><div class="l">Refusal reversals since 2019</div></div><div class="s"><div class="num">30%</div><div class="l">Of enquiries advised to wait and reapply later</div></div></div><p class="note" style="margin:0 auto 24px">We count an approval as a reversal only when the applicant was previously refused for the same destination or Schengen zone. These are not first time applicants.</p><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Check your case on WhatsApp</a></div></div></section><span id="faq"></span><section class="pad"><div class="wrap"><div class="sh center"><div class="label teal">FAQ</div><h2>Common questions.</h2></div><div class="faqgrid"><div class="c"><h3>Will the consulate hold my previous refusal against me?</h3><p>Yes. Your refusal is on record and visible to every Schengen consulate, not just the one that refused you. This is why the reapplication needs to be substantially different. Minor tweaks confirm the original decision rather than challenging it.</p></div><div class="c"><h3>How long should I wait before reapplying?</h3><p>There is no mandatory waiting period for most Schengen refusals. But can and should are different questions. Some people are ready immediately with the right changes. Others need three to six months. We will tell you which group you fall into.</p></div><div class="c"><h3>Should I apply to a different country to avoid the refusal showing up?</h3><p>It will show up regardless. Schengen countries share records through the Visa Information System. Switching countries does not give you a clean slate. In some cases it raises additional questions.</p></div><div class="c"><h3>Can I appeal instead of reapplying?</h3><p>Some consulates offer an appeal process. In practice appeals rarely succeed because they are reviewed against the same criteria by the same system. A fresh, rebuilt application is almost always stronger.</p></div><div class="c"><h3>What do you need from me to review my case?</h3><p>Your refusal letter, a copy of the application you originally submitted, and the supporting documents. If you do not have copies of everything, send what you have on WhatsApp and we will tell you what else we need.</p></div></div></div></section><section class="pad"><div class="wrap"><div class="ctapanel" style="background:linear-gradient(120deg,rgba(10,22,40,.93),rgba(19,40,76,.82)),radial-gradient(700px 320px at 85% 10%,rgba(57,184,156,.20),transparent 60%),radial-gradient(900px 480px at 80% -8%,rgba(44,126,155,.20),transparent 60%) center/cover no-repeat"><svg class="mark" viewBox="0 0 240 210" fill="none" aria-hidden="true">
...
<g stroke="#fff" stroke-width="2.2" fill="none"><circle cx="178" cy="128" r="14"/><path d="M178 114v28M164 128h28M178 114q-8 14 0 28M178 114q8 14 0 28"/></g></svg><h2>That refusal letter is not the end of the story.</h2><p class="lead">You are holding a decision based on one officer&#x27;s reading of one version of your application on one day. It can be different, but only if the next application is fundamentally stronger, not just slightly adjusted. Send us the letter. We will read it, decode it, and tell you honestly whether now is the time.</p><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Send your refusal letter on WhatsApp</a><p class="sub">Most people hear back within a few hours during UK business hours.</p></div></div></section><footer class="foot"><div class="wrap"><div class="brand" style="font-size:1rem"><img src="{{ asset('assets/brand/bp-logo-v2.svg') }}" alt="Beyond Passports" height="40" style="display:block;height:40px;width:auto"></div><p class="disc">UK & Germany Registered. Beyond Passports is an independent visa support service. We are not a government body and not affiliated with any consulate or embassy. The consulate makes the final decision on every application. Embassy and consulate fees are paid by you directly to the relevant authority.</p><p class="disc" style="font-size:.82rem;opacity:.85">&copy; Beyond Passports</p></div></footer>
