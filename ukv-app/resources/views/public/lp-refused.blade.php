...
<path d="M142 98 C108 80 80 72 56 70 C80 86 110 98 136 108 Z" fill="#fff"/>
<path d="M144 112 C128 138 106 160 80 176 C112 156 138 128 150 104 Z" fill="#fff"/>
<g stroke="#fff" stroke-width="2.2" fill="none"><circle cx="178" cy="128" r="14"/><path d="M178 114v28M164 128h28M178 114q-8 14 0 28M178 114q8 14 0 28"/></g></svg><span style="color:#fff;font-weight:800">Beyond</span><span>Passports</span></div><p class="disc">OISC registered. Regulated by the Office of the Immigration Services Commissioner. Beyond Passports is an independent visa support service. We are not a government body and not affiliated with any consulate or embassy. The consulate makes the final decision on every application. Embassy and consulate fees are paid by you directly to the relevant authority.</p><p class="disc" style="font-size:.82rem;opacity:.85">&copy; Beyond Passports</p></div></footer>
