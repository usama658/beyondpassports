...
@if(config('ukv.legal.draft_notice'))
          ...
          @if($ukvIco !== '')<p>We are registered with the UK <strong>Information Commissioner's Office (ICO)</strong> as a data controller under reference <strong>{{ $ukvIco }}</strong>. You can verify this on the public ICO register at <a href="https://ico.org.uk/ESDWebPages/Entry/{{ rawurlencode($ukvIco) }}" target="_blank" rel="noopener">ico.org.uk</a>.</p>@endif
...
<section class="cta-band">
  <div class="wrap reveal">
    ...
    <div class="row">
      ...
      <a href="https://wa.me/{{ config('ukv.whatsapp') ?: '4915213103462' }}?text={{ rawurlencode('Hi Beyond Passports, I have a question.') }}" class="btn btn--glass">@include('partials.wa-glyph')Chat on WhatsApp</a>
    </div>
