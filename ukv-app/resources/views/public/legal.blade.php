...
<style>
  ...
  .doc-body .updated{font-family:var(--mono);font-size:12px;letter-spacing:.04em;color:#6b7d87;margin:0 0 4px}
  ...
  <div class="legal-shell">
    ...
    <div class="doc-body">
      ...
      <article class="legal-sec" id="privacy" aria-labelledby="privacy-h">
        ...
        <p>This policy explains what personal data UKVisaCo collects when you use our visa and eVisa facilitation service, why we collect it, how long we keep it, and the rights you have over it. UKVisaCo is the data controller for the information described here.</p>

        <h3>What data we collect</h3>
        <ul class="plain">
          <li><strong>Identity &amp; contact details</strong> — your name, email address, phone number and billing address.</li>
          <li><strong>Passport &amp; travel details</strong> — passport number, nationality, date and place of birth, travel dates, destination and trip purpose, plus any supporting documents you upload.</li>
          <li><strong>Order &amp; payment information</strong> — your order reference, the service options you chose, and payment confirmation (card details are handled by our payment processor, not stored by us).</li>
        ...
        <p>We process your data primarily to <strong>perform our contract</strong> with you — checking, preparing and submitting your visa or eVisa application and keeping you updated. Where we process special-category or sensitive details contained in travel documents, we rely on your <strong>explicit consent</strong>, which you may withdraw at any time. We also process limited data to meet legal obligations and for our legitimate interest in securing and improving the service.</p>

        <h3>How long we keep it (retention &amp; auto-purge)</h3>
        <p>We keep application data only as long as needed to deliver your order and meet our legal and accounting duties. Sensitive passport and travel documents are <strong>automatically purged</strong> a short period after your application is completed or cancelled. Basic order records are retained for the period required by tax and consumer law, then deleted.</p>

        <h3>Sub-processors</h3>
        <p>We share data with carefully selected providers acting on our instructions, including a <strong>payment processor</strong> (to take payment), a <strong>CRM provider</strong> (to manage your case and communications), a <strong>hosting provider</strong> (to run this site) and an <strong>email provider</strong> (to send confirmations and updates). Each is bound by a data-processing agreement.</p>

        <h3>Cross-border transfers</h3>
        <p>Some of our sub-processors operate in the <strong>United States</strong>. Where data is transferred outside the UK, we rely on appropriate safeguards — such as UK International Data Transfer Agreements, the UK Extension to the EU-US Data Privacy Framework, or equivalent contractual protections — so your data continues to receive an essentially equivalent level of protection.</p>

        <h3>Your rights</h3>
        <p>You have the right to access, correct, erase, restrict or object to our processing of your data, to data portability, and to withdraw consent where processing is consent-based. To exercise any of these, contact us at <a href="mailto:privacy@ukvisaco.example">privacy@ukvisaco.example</a> and we will respond within the statutory timeframe.</p>

        <h3>Complaining to the ICO</h3>
        <p>If you are unhappy with how we have handled your data, you can lodge a complaint with the UK <strong>Information Commissioner's Office (ICO)</strong> at <a href="https://ico.org.uk" rel="noopener">ico.org.uk</a> or on 0303 123 1113. We would, however, appreciate the chance to resolve your concern first.</p>
      ...
      <article class="legal-sec" id="terms" aria-labelledby="terms-h">
        ...
        <p>These terms govern your use of UKVisaCo's service. By placing an order you agree to them. Please read them alongside our Privacy Policy and Disclaimer below.</p>
        ...
        <p>Under the <strong>Consumer Contracts Regulations 2013</strong> you have a <strong>14-day right to cancel</strong> from the day you place your order. Note: if you ask us to begin work within that period, you may be charged for work already done, and once a service is fully performed (for example, your application has been submitted) the right to cancel may be lost. Our refund policy and any deductions will be summarised at checkout and in your confirmation email.</p>

        <h3>Liability</h3>
        <p>To the extent permitted by law, our liability for any claim arising from the service is limited to the amount of the <strong>service fee you paid us</strong> for the relevant order. Nothing in these terms excludes liability that cannot lawfully be excluded, including for death or personal injury caused by negligence or for fraud. These terms do not affect your statutory rights.</p>
      ...
      <article class="legal-sec" id="complaints" aria-labelledby="complaints-h">
        ...
        <ul class="plain">
          <li>We will <strong>acknowledge</strong> your complaint within <strong>3 working days</strong>.</li>
          <li>We aim to provide a <strong>full written response within 15 working days</strong>. If we need longer, we'll explain why and give a new date.</li>
        </ul>

        <h3>Escalation</h3>
        <p>If you're not satisfied with our final response, you may ask for it to be reviewed by a senior member of our team. Where relevant, you may also be able to raise the matter with an alternative dispute resolution body or with <strong>Trading Standards</strong> via the Citizens Advice consumer service. Data-handling complaints can be taken to the <a href="https://ico.org.uk" rel="noopener">ICO</a>.</p>
