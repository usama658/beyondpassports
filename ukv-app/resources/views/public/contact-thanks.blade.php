...
@section('title', 'Thanks, your callback is booked | Beyond Passports')
@section('description', 'Your callback request is in. We are opening WhatsApp so your enquiry reaches our team there too.')
...
<section class="ct-thanks"><div class="wrap">
  <div class="tk-grid">
    <div class="tk-left">
      ...
      <a href="{{ url('/') }}" class="tk-home">Back to home</a>
    </div>
