...
{{-- LP /schengen-visa-agent-premium — ORIGINAL docx Page E (Speed), site warm-light theme.
     Orphan: noindex, not in nav/footer/sitemap. CTAs read config('ukv.whatsapp'). --}}
<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex, nofollow"><title>Your Schengen visa in 5 working days | Beyond Passports</title><style>@font-face{font-family:'Outfit';src:url('/fonts/outfit-400.woff2') format('woff2');font-weight:400;font-display:swap}@font-face{font-family:'Outfit';src:url('/fonts/outfit-600.woff2') format('woff2');font-weight:600;font-display:swap}@font-face{font-family:'Outfit';src:url('/fonts/outfit-700.woff2') format('woff2');font-weight:700;font-display:swap}@font-face{font-family:'Outfit';src:url('/fonts/outfit-800.woff2') format('woff2');font-weight:800;font-display:swap}
:root{
...
</style></head><body><div class="tbpetrol"><div class="tbp"><span class="tcell"><svg class="ti" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2l8 3v6c0 5-3.5 8.5-8 10-4.5-1.5-8-5-8-10V5z"/><path d="M9 12l2 2 4-4"/></svg><b>UK &amp; Germany Registered</b></span><span class="tcell"><span class="tn">4,200+</span> applications filed</span><span class="tcell"><svg class="tflag" viewBox="0 0 60 36"><clipPath id="ukc2"><rect width="60" height="36" rx="4"/></clipPath><g clip-path="url(#ukc2)"><rect width="60" height="36" fill="#012169"/><path d="M0 0l60 36M60 0L0 36" stroke="#fff" stroke-width="7"/><path d="M0 0l60 36M60 0L0 36" stroke="#C8102E" stroke-width="4"/><path d="M30 0v36M0 18h60" stroke="#fff" stroke-width="11"/><path d="M30 0v36M0 18h60" stroke="#C8102E" stroke-width="6"/></g></svg><svg class="tflag" viewBox="0 0 60 36"><rect width="60" height="36" rx="4" fill="#FFCE00"/><rect width="60" height="12" rx="4" fill="#000"/><rect y="12" width="60" height="12" fill="#D00"/></svg> UK &amp; Germany teams</span><a class="tverify" href="https://www.gov.uk/foreign-travel-advice" target="_blank" rel="noopener">Verify on gov.uk</a></div></div><header class="nav"><div class="wrap"><a class="brand" href="{{ $wa }}" target="_blank" rel="noopener"><img src="{{ asset('assets/brand/bp-logo-v2.svg') }}" alt="Beyond Passports" height="34" style="display:block;height:34px;width:auto"></a><nav class="navpill"><a class="nl" href="#how">How it works</a><a class="nl active" href="#pricing">Pricing</a><a class="nl" href="#track">Track record</a><a class="nl" href="#reviews">Reviews</a><a class="nl" href="#faq">FAQ</a></nav><a class="navcta" href="{{ $wa }}" target="_blank" rel="noopener">Message on WhatsApp</a></div></header><section class="hero" style="text-align:center"><div class="wrap"><div class="label teal" style="justify-content:center">Speed and outcome</div><h1 style="margin-left:auto;margin-right:auto">Your Schengen visa submitted in <span class="hl" style="color:var(--teal)">5 working days</span>.</h1><p class="lead" style="margin-left:auto;margin-right:auto">You send the documents. We handle the rest. One appointment, one signature, done.</p><div class="cta-row" style="justify-content:center"><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Send us your travel dates on WhatsApp</a></div><div class="tbp tbp-hero"><span class="tcell"><svg class="ti" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2l8 3v6c0 5-3.5 8.5-8 10-4.5-1.5-8-5-8-10V5z"/><path d="M9 12l2 2 4-4"/></svg><b>UK &amp; Germany Registered</b></span><span class="tcell"><span class="tn">4,200+</span> applications filed</span><span class="tcell"><svg class="tflag" viewBox="0 0 60 36"><clipPath id="ukc"><rect width="60" height="36" rx="4"/></clipPath><g clip-path="url(#ukc)"><rect width="60" height="36" fill="#012169"/><path d="M0 0l60 36M60 0L0 36" stroke="#fff" stroke-width="7"/><path d="M0 0l60 36M60 0L0 36" stroke="#C8102E" stroke-width="4"/><path d="M30 0v36M0 18h60" stroke="#fff" stroke-width="11"/><path d="M30 0v36M0 18h60" stroke="#C8102E" stroke-width="6"/></g></svg><svg class="tflag" viewBox="0 0 60 36"><rect width="60" height="36" rx="4" fill="#FFCE00"/><rect width="60" height="12" rx="4" fill="#000"/><rect y="12" width="60" height="12" fill="#D00"/></svg> UK &amp; Germany teams</span></div></div></section><section class="pad"><div class="wrap"><div class="sh"><div class="label ">The numbers that matter</div><h2>Built for speed, measured on outcome.</h2></div><div class="statrow"><div class="si"><div class="sn">97%</div><div class="sl">Approval rate across all application types</div></div><div class="si"><div class="sn">5<span class="su">working days</span></div><div class="sl">Average time from documents received to submitted</div></div><div class="si"><div class="sn">4,200+</div><div class="sl">Applications filed since 2019</div></div><div class="si"><div class="sn">2<span class="su">visits max</span></div><div class="sl">Most clients visit the centre once or twice. Never more.</div></div></div><div class="cta-row"><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Check your timeline on WhatsApp</a></div></div></section><span id="track"></span><section class="pad"><div class="wrap"><div class="sh"><div class="label ">Current appointment availability</div><h2>The wait depends on which door you knock on.</h2><p class="lead">Live wait times across Schengen consulates. Updated weekly.</p></div><div class="grid g3"><div class="card"><div style="font-weight:800;font-size:1.05rem">Germany</div><div style="display:flex;align-items:center;gap:10px;margin-top:10px"><span style="color:var(--mut2);text-decoration:line-through;font-size:.9rem">3 weeks</span><span style="color:var(--teal)"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2.4" style="vertical-align:-3px"><path d="M5 12h14M13 6l6 6-6 6"/></svg></span><span style="font-weight:800;color:var(--teal)">5 working days</span></div></div><div class="card"><div style="font-weight:800;font-size:1.05rem">Switzerland</div><div style="display:flex;align-items:center;gap:10px;margin-top:10px"><span style="color:var(--mut2);text-decoration:line-through;font-size:.9rem">3 weeks</span><span style="color:var(--teal)"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2.4" style="vertical-align:-3px"><path d="M5 12h14M13 6l6 6-6 6"/></svg></span><span style="font-weight:800;color:var(--teal)">5 working days</span></div></div><div class="card"><div style="font-weight:800;font-size:1.05rem">Spain</div><div style="display:flex;align-items:center;gap:10px;margin-top:10px"><span style="color:var(--mut2);text-decoration:line-through;font-size:.9rem">4 weeks</span><span style="color:var(--teal)"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2.4" style="vertical-align:-3px"><path d="M5 12h14M13 6l6 6-6 6"/></svg></span><span style="font-weight:800;color:var(--teal)">6 working days</span></div></div><div class="card"><div style="font-weight:800;font-size:1.05rem">Netherlands</div><div style="display:flex;align-items:center;gap:10px;margin-top:10px"><span style="color:var(--mut2);text-decoration:line-through;font-size:.9rem">4 weeks</span><span style="color:var(--teal)"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2.4" style="vertical-align:-3px"><path d="M5 12h14M13 6l6 6-6 6"/></svg></span><span style="font-weight:800;color:var(--teal)">6 working days</span></div></div><div class="card"><div style="font-weight:800;font-size:1.05rem">Italy</div><div style="display:flex;align-items:center;gap:10px;margin-top:10px"><span style="color:var(--mut2);text-decoration:line-through;font-size:.9rem">5 weeks</span><span style="color:var(--teal)"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2.4" style="vertical-align:-3px"><path d="M5 12h14M13 6l6 6-6 6"/></svg></span><span style="font-weight:800;color:var(--teal)">7 working days</span></div></div><div class="card"><div style="font-weight:800;font-size:1.05rem">France</div><div style="display:flex;align-items:center;gap:10px;margin-top:10px"><span style="color:var(--mut2);text-decoration:line-through;font-size:.9rem">6 weeks</span><span style="color:var(--teal)"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2.4" style="vertical-align:-3px"><path d="M5 12h14M13 6l6 6-6 6"/></svg></span><span style="font-weight:800;color:var(--teal)">8 working days</span></div></div></div><p class="note">Germany consistently has the shortest processing window. We secure German appointments faster than any other consulate route.</p><div class="cta-row"><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Ask which route is fastest for your trip</a></div></div></section><span id="how"></span><section class="pad"><div class="wrap"><div class="sh"><div class="label ">How it works</div><h2>5 days. 4 steps. You do almost nothing.</h2></div><div class="grid g4"><div class="card"><div style="font-weight:800;color:var(--teal);margin-bottom:10px">Day 1</div><p style="margin:0;color:var(--mut);font-size:.9rem"><b style="color:var(--teal)">You:</b> send us your passport scan and travel dates on WhatsApp.</p><p style="margin:8px 0 0;color:var(--mut);font-size:.9rem"><b style="color:var(--gold)">We:</b> review your eligibility, confirm your route, and tell you exactly what documents we need.</p></div><div class="card"><div style="font-weight:800;color:var(--teal);margin-bottom:10px">Days 2 and 3</div><p style="margin:0;color:var(--mut);font-size:.9rem"><b style="color:var(--teal)">You:</b> upload your documents. Bank statements, employer letter, accommodation.</p><p style="margin:8px 0 0;color:var(--mut);font-size:.9rem"><b style="color:var(--gold)">We:</b> prepare your entire application. Every form filled and formatted to consulate spec. Cover letter written.</p></div><div class="card"><div style="font-weight:800;color:var(--teal);margin-bottom:10px">Day 4</div><p style="margin:0;color:var(--mut);font-size:.9rem"><b style="color:var(--teal)">You:</b> visit the application centre. Submit the prepared file, give biometrics. 20 minutes.</p><p style="margin:8px 0 0;color:var(--mut);font-size:.9rem"><b style="color:var(--gold)">We:</b> brief you the night before. Exactly what to bring, where to go, what to expect.</p></div><div class="card"><div style="font-weight:800;color:var(--teal);margin-bottom:10px">Day 5</div><p style="margin:0;color:var(--mut);font-size:.9rem"><b style="color:var(--teal)">You:</b> nothing. Wait.</p><p style="margin:8px 0 0;color:var(--mut);font-size:.9rem"><b style="color:var(--gold)">We:</b> track your application status and notify you the moment a decision lands.</p></div></div><div class="cta-row"><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Start your 5 day timeline on WhatsApp</a></div></div></section><span id="pricing"></span><section class="pad"><div class="wrap"><div class="sh center"><div class="label ">Pricing</div><h2>Three options. Pick the one that fits.</h2></div><div class="grid g3"><div style="background:var(--surf2);border:1px solid var(--line);border-radius:18px;padding:26px;display:flex;flex-direction:column"><div style="font-size:.8rem;font-weight:800;letter-spacing:.1em;text-transform:uppercase;color:var(--mut2)">Standard</div><div style="font-size:2.4rem;font-weight:800;letter-spacing:-.03em;margin:4px 0">£250</div><div style="display:inline-block;align-self:flex-start;background:rgba(46,154,140,.10);color:var(--teal);font-weight:600;font-size:.82rem;padding:6px 12px;border-radius:999px;margin:2px 0 14px">Best for: Planned holidays with flexible dates</div><ul style="list-style:none;margin:0 0 18px;padding:0;flex:1"><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Full application preparation</span></li><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Document review and formatting</span></li><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Appointment booking</span></li><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Submission day briefing</span></li><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Status tracking until decision</span></li></ul><a href="{{ $wa }}" target="_blank" rel="noopener" style="display:block;text-align:center;font-weight:700;padding:12px;border-radius:11px;text-decoration:none;border:1.5px solid var(--cta);color:var(--cta)">Choose Standard</a></div><div style="background:var(--surf2);border:2px solid var(--teal);position:relative;border-radius:18px;padding:26px;display:flex;flex-direction:column"><div style="position:absolute;top:-12px;left:50%;transform:translateX(-50%);background:var(--teal);color:#fff;font-size:.7rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase;padding:5px 14px;border-radius:999px">Most popular</div><div style="font-size:.8rem;font-weight:800;letter-spacing:.1em;text-transform:uppercase;color:var(--mut2)">Premium</div><div style="font-size:2.4rem;font-weight:800;letter-spacing:-.03em;margin:4px 0">£450</div><div style="display:inline-block;align-self:flex-start;background:rgba(46,154,140,.10);color:var(--teal);font-weight:600;font-size:.82rem;padding:6px 12px;border-radius:999px;margin:2px 0 14px">Best for: Business travel and short notice trips</div><ul style="list-style:none;margin:0 0 18px;padding:0;flex:1"><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Everything in Standard</span></li><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Priority appointment sourcing</span></li><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Cover letter by senior consultants</span></li><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Pre-submission quality audit</span></li><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Same day response to all queries</span></li></ul><a href="{{ $wa }}" target="_blank" rel="noopener" style="display:block;text-align:center;font-weight:700;padding:12px;border-radius:11px;text-decoration:none;background:var(--cta);color:#fff">Choose Premium</a></div><div style="background:var(--surf2);border:1px solid var(--line);border-radius:18px;padding:26px;display:flex;flex-direction:column"><div style="font-size:.8rem;font-weight:800;letter-spacing:.1em;text-transform:uppercase;color:var(--mut2)">Urgent</div><div style="font-size:2.4rem;font-weight:800;letter-spacing:-.03em;margin:4px 0">£650</div><div style="display:inline-block;align-self:flex-start;background:rgba(46,154,140,.10);color:var(--teal);font-weight:600;font-size:.82rem;padding:6px 12px;border-radius:999px;margin:2px 0 14px">Best for: Last minute travel, conferences, emergencies</div><ul style="list-style:none;margin:0 0 18px;padding:0;flex:1"><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Everything in Premium</span></li><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Fastest appointment within 48 hours</span></li><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Application prepared within 2 working days</span></li><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Direct WhatsApp line</span></li><li style="display:flex;gap:8px;align-items:flex-start;font-size:.9rem;color:var(--mut);padding:5px 0"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2.6" style="flex:0 0 16px;margin-top:3px"><path d="M20 6L9 17l-5-5"/></svg><span>Weekend preparation available</span></li></ul><a href="{{ $wa }}" target="_blank" rel="noopener" style="display:block;text-align:center;font-weight:700;padding:12px;border-radius:11px;text-decoration:none;border:1.5px solid var(--cta);color:var(--cta)">Choose Urgent</a></div></div><p class="note" style="text-align:center;margin-left:auto;margin-right:auto">Family discount: second and third applicants get 30% off any tier. Fourth applicant onwards at 50% off.</p></div></section><section class="pad"><div class="wrap"><div class="sh"><div class="label ">What you get</div><h2>Everything that normally goes wrong, handled.</h2></div><div class="grid g2"><div class="card" style="display:flex;gap:12px;align-items:flex-start"><span style="flex:0 0 34px;width:34px;height:34px;border-radius:9px;background:rgba(46,154,140,.14);display:flex;align-items:center;justify-content:center"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2.6"><path d="M20 6L9 17l-5-5"/></svg></span><div><h3 style="margin:0;font-size:1rem;font-weight:700">Correct forms, correct consulate</h3><p style="margin:5px 0 0;color:var(--mut);font-size:.9rem">We match your application to the right Schengen entry point. Wrong consulate is the most common rejection reason. It will not happen here.</p></div></div><div class="card" style="display:flex;gap:12px;align-items:flex-start"><span style="flex:0 0 34px;width:34px;height:34px;border-radius:9px;background:rgba(46,154,140,.14);display:flex;align-items:center;justify-content:center"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2.6"><path d="M20 6L9 17l-5-5"/></svg></span><div><h3 style="margin:0;font-size:1rem;font-weight:700">Bank statements reviewed before submission</h3><p style="margin:5px 0 0;color:var(--mut);font-size:.9rem">We check your financials meet the threshold before your appointment. No surprises at the counter.</p></div></div><div class="card" style="display:flex;gap:12px;align-items:flex-start"><span style="flex:0 0 34px;width:34px;height:34px;border-radius:9px;background:rgba(46,154,140,.14);display:flex;align-items:center;justify-content:center"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2.6"><path d="M20 6L9 17l-5-5"/></svg></span><div><h3 style="margin:0;font-size:1rem;font-weight:700">Cover letter written for your specific trip</h3><p style="margin:5px 0 0;color:var(--mut);font-size:.9rem">Not a template. A letter that explains your travel purpose, ties, and return plans in the language consulates expect.</p></div></div><div class="card" style="display:flex;gap:12px;align-items:flex-start"><span style="flex:0 0 34px;width:34px;height:34px;border-radius:9px;background:rgba(46,154,140,.14);display:flex;align-items:center;justify-content:center"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2.6"><path d="M20 6L9 17l-5-5"/></svg></span><div><h3 style="margin:0;font-size:1rem;font-weight:700">Appointment booked at the earliest slot</h3><p style="margin:5px 0 0;color:var(--mut);font-size:.9rem">We monitor availability daily. When a cancellation opens up, we grab it.</p></div></div><div class="card" style="display:flex;gap:12px;align-items:flex-start"><span style="flex:0 0 34px;width:34px;height:34px;border-radius:9px;background:rgba(46,154,140,.14);display:flex;align-items:center;justify-content:center"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2.6"><path d="M20 6L9 17l-5-5"/></svg></span><div><h3 style="margin:0;font-size:1rem;font-weight:700">Document formatting to consulate spec</h3><p style="margin:5px 0 0;color:var(--mut);font-size:.9rem">Paper size, photo dimensions, photocopy requirements, translation certifications. Every consulate has different rules. We know them all.</p></div></div><div class="card" style="display:flex;gap:12px;align-items:flex-start"><span style="flex:0 0 34px;width:34px;height:34px;border-radius:9px;background:rgba(46,154,140,.14);display:flex;align-items:center;justify-content:center"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2.6"><path d="M20 6L9 17l-5-5"/></svg></span><div><h3 style="margin:0;font-size:1rem;font-weight:700">Status tracking with real updates</h3><p style="margin:5px 0 0;color:var(--mut);font-size:.9rem">We check your application status so you do not have to refresh the portal. You get a WhatsApp message when something changes.</p></div></div><div class="card" style="display:flex;gap:12px;align-items:flex-start"><span style="flex:0 0 34px;width:34px;height:34px;border-radius:9px;background:rgba(46,154,140,.14);display:flex;align-items:center;justify-content:center"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2.6"><path d="M20 6L9 17l-5-5"/></svg></span><div><h3 style="margin:0;font-size:1rem;font-weight:700">Reapplication support if needed</h3><p style="margin:5px 0 0;color:var(--mut);font-size:.9rem">On the rare occasion an application is refused, we review the refusal letter, identify the issue, and prepare a fresh submission at no extra consultation fee.</p></div></div></div><div class="cta-row"><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>See exactly what is included for your trip</a></div></div></section><span id="reviews"></span><section class="pad"><div class="wrap"><div class="sh"><div class="label ">Recent outcomes</div><h2>Last 5 applications. All approved.</h2></div><table style="width:100%;border-collapse:separate;border-spacing:0;background:var(--surf2);border:1px solid var(--line);border-radius:16px;overflow:hidden"><thead><tr><th style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);background:rgba(125,140,160,.10);font-size:.72rem;letter-spacing:.08em;text-transform:uppercase;color:var(--mut2);font-weight:800">Destination</th><th style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);background:rgba(125,140,160,.10);font-size:.72rem;letter-spacing:.08em;text-transform:uppercase;color:var(--mut2);font-weight:800">Purpose</th><th style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);background:rgba(125,140,160,.10);font-size:.72rem;letter-spacing:.08em;text-transform:uppercase;color:var(--mut2);font-weight:800">Docs to visa</th><th style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);background:rgba(125,140,160,.10);font-size:.72rem;letter-spacing:.08em;text-transform:uppercase;color:var(--mut2);font-weight:800">Status</th></tr></thead><tbody><tr><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><b>France</b></td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem">Business conference</td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><b style="color:var(--teal)">9 days</b></td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><span style="display:inline-flex;align-items:center;background:rgba(46,154,140,.14);color:#1F6E63;font-weight:700;font-size:.78rem;padding:5px 11px;border-radius:999px"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="#1F6E63" stroke-width="2.6" style="vertical-align:-2px;margin-right:5px"><path d="M20 6L9 17l-5-5"/></svg>Approved</span></td></tr><tr><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><b>Germany</b></td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem">Family visit</td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><b style="color:var(--teal)">7 days</b></td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><span style="display:inline-flex;align-items:center;background:rgba(46,154,140,.14);color:#1F6E63;font-weight:700;font-size:.78rem;padding:5px 11px;border-radius:999px"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="#1F6E63" stroke-width="2.6" style="vertical-align:-2px;margin-right:5px"><path d="M20 6L9 17l-5-5"/></svg>Approved</span></td></tr><tr><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><b>Italy</b></td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem">Holiday</td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><b style="color:var(--teal)">11 days</b></td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><span style="display:inline-flex;align-items:center;background:rgba(46,154,140,.14);color:#1F6E63;font-weight:700;font-size:.78rem;padding:5px 11px;border-radius:999px"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="#1F6E63" stroke-width="2.6" style="vertical-align:-2px;margin-right:5px"><path d="M20 6L9 17l-5-5"/></svg>Approved</span></td></tr><tr><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><b>Netherlands</b></td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem">Work meetings</td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><b style="color:var(--teal)">8 days</b></td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><span style="display:inline-flex;align-items:center;background:rgba(46,154,140,.14);color:#1F6E63;font-weight:700;font-size:.78rem;padding:5px 11px;border-radius:999px"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="#1F6E63" stroke-width="2.6" style="vertical-align:-2px;margin-right:5px"><path d="M20 6L9 17l-5-5"/></svg>Approved</span></td></tr><tr><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><b>Spain</b></td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem">Wedding attendance (previously refused)</td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><b style="color:var(--teal)">10 days</b></td><td style="padding:14px 18px;text-align:left;border-bottom:1px solid var(--line);font-size:.93rem"><span style="display:inline-flex;align-items:center;background:rgba(46,154,140,.14);color:#1F6E63;font-weight:700;font-size:.78rem;padding:5px 11px;border-radius:999px"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="#1F6E63" stroke-width="2.6" style="vertical-align:-2px;margin-right:5px"><path d="M20 6L9 17l-5-5"/></svg>Approved</span></td></tr></tbody></table><p class="note">Turnaround includes consulate processing time, which varies by country. Our preparation time is consistently 5 working days or fewer.</p><div class="cta-row"><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Get a realistic timeline for your trip</a></div></div></section><span id="faq"></span><section class="pad"><div class="wrap"><div class="sh center"><div class="label teal">FAQ</div><h2>Common questions.</h2></div><div class="faqgrid"><div class="c"><h3>Do I need to visit anywhere?</h3><p>The only place you need to visit is the visa application centre, once, to submit your file and provide biometrics. We brief you fully beforehand so you know exactly what to expect. Everything else is handled through WhatsApp.</p></div><div class="c"><h3>My trip is in 10 days. Can you still help?</h3><p>Possibly. It depends on appointment availability at the relevant consulate. Message us with your travel date and we will tell you within the hour whether the timeline is achievable. If it is, we move to our urgent track immediately.</p></div><div class="c"><h3>I have been refused a Schengen visa before. Will that be a problem?</h3><p>A previous refusal does not automatically mean another refusal. It depends on why you were refused and what has changed since. Send us your previous refusal letter and we will assess whether a new application is viable and what needs to be different this time.</p></div><div class="c"><h3>What if my visa is refused after using your service?</h3><p>We review the refusal notice, identify the cause, and prepare a fresh submission at no extra consultation fee. We cannot override a consulate decision, but we make sure the next application is as strong as it can be.</p></div></div></div></section><section class="pad"><div class="wrap"><div class="ctapanel" style="background:linear-gradient(120deg,rgba(10,22,40,.93),rgba(19,40,76,.82)),radial-gradient(700px 320px at 85% 10%,rgba(57,184,156,.20),transparent 60%),radial-gradient(900px 480px at 80% -8%,rgba(44,126,155,.20),transparent 60%) center/cover no-repeat"><svg class="mark" viewBox="0 0 240 210" fill="none" aria-hidden="true">
...
<g stroke="#fff" stroke-width="2.2" fill="none"><circle cx="178" cy="128" r="14"/><path d="M178 114v28M164 128h28M178 114q-8 14 0 28M178 114q8 14 0 28"/></g></svg><h2>Ready when you are.</h2><p class="lead">Send us your passport scan and travel dates. We confirm your timeline, recommend the right tier, and get your application moving.</p><a class="btn btn-wa" href="{{ $wa }}" target="_blank" rel="noopener"><svg class="wi" viewBox="0 0 32 32" fill="currentColor"><path d="M16 3C9 3 3.5 8.5 3.5 15.5c0 2.4.7 4.6 1.8 6.5L3 29l7.2-2.2c1.8 1 3.9 1.5 6 1.5 7 0 12.5-5.5 12.5-12.5S23 3 16 3zm0 22.7c-1.9 0-3.7-.5-5.3-1.5l-.4-.2-3.8 1.1 1.1-3.7-.3-.4c-1-1.6-1.6-3.5-1.6-5.5C5.4 9.6 10.2 5 16 5s10.6 4.6 10.6 10.5S21.8 25.7 16 25.7zm6-7.8c-.3-.2-1.9-1-2.2-1.1-.3-.1-.5-.2-.8.2s-.9 1.1-1.1 1.3c-.2.2-.4.2-.7.1-1.9-.9-3.1-1.7-4.4-3.8-.3-.5.3-.5.9-1.6.1-.2 0-.4 0-.6s-.8-1.9-1-2.6c-.3-.7-.6-.6-.8-.6h-.6c-.2 0-.6.1-.9.4-.3.4-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.5 3.8 6 5.3 2.2 1 3.1 1 4.2.9.7-.1 1.9-.8 2.2-1.5.3-.8.3-1.4.2-1.5-.1-.2-.3-.3-.6-.4z"/></svg>Message us on WhatsApp</a><p class="sub">Replies within 2 hours during business days. Often faster.</p></div></div></section><footer class="foot"><div class="wrap"><div class="brand" style="font-size:1rem"><svg class="mark" viewBox="0 0 240 210" fill="none" aria-hidden="true">
<path d="M150 66 Q149 59 156 59 L206 67 Q213 68 212 75 L205 162 Q204 169 197 168 L147 160 Q140 159 141 152 Z" fill="#39B89C"/>
<path d="M140 86 C102 62 70 50 44 44 C66 62 102 82 132 100 Z" fill="#fff"/>
<path d="M142 98 C108 80 80 72 56 70 C80 86 110 98 136 108 Z" fill="#fff"/>
<path d="M144 112 C128 138 106 160 80 176 C112 156 138 128 150 104 Z" fill="#fff"/>
<g stroke="#fff" stroke-width="2.2" fill="none"><circle cx="178" cy="128" r="14"/><path d="M178 114v28M164 128h28M178 114q-8 14 0 28M178 114q8 14 0 28"/></g></svg><span style="color:#fff;font-weight:800">Beyond</span><span>Passports</span></div><p class="disc">UK & Germany Registered. Beyond Passports is an independent visa support service. We are not a government body and not affiliated with any consulate or embassy. The consulate makes the final decision on every application. Embassy and consulate fees are paid by you directly to the relevant authority.</p><p class="disc" style="font-size:.82rem;opacity:.85">&copy; Beyond Passports</p></div></footer>
...
.stat .big .bu{display:block;font:600 .9rem/1.25 'Outfit',system-ui,sans-serif !important;letter-spacing:0 !important;margin-top:5px;-webkit-text-fill-color:#5d6b76 !important;color:#5d6b76 !important}
/* editorial stats (variant C) */
.numgrid{display:grid !important;grid-template-columns:1.05fr 1.3fr;gap:40px;align-items:center;margin-top:6px}
.numhero{border-right:1px solid rgba(20,34,46,.12);padding-right:36px}
.numhero .nbig{font:800 clamp(64px,8vw,92px)/.9 'Outfit',sans-serif;letter-spacing:-.04em;background:linear-gradient(180deg,#155E7A,#2E9A8C);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;color:transparent}
.numhero .npct{-webkit-text-fill-color:transparent}
.numhero .nhh{font:800 26px/1.1 'Outfit',sans-serif;margin:14px 0 4px;color:#16222E;-webkit-text-fill-color:#16222E}
.numhero .nhp{font-size:15px;color:#5d6b76;margin:0}
.nummini{display:flex;flex-direction:column;gap:0}
.nummini .m{padding:18px 0;border-bottom:1px solid rgba(20,34,46,.12)}
...
/* top band: transparent pill on petrol, white text */
.tbpetrol .tbp{background:transparent !important;border:0 !important;box-shadow:none !important;padding:12px 0 !important}
.tbpetrol .tbp .tcell{color:#fff;border-right-color:rgba(255,255,255,.28)}
.tbpetrol .tbp .tcell .ti{color:#7fe6cf}
.tbpetrol .tbp .tcell .tn{color:#fff !important}
.tbpetrol .tbp .tverify{color:#fff;border-left-color:rgba(255,255,255,.28)}
/* stats: 4 equal in a row */
.statrow{display:grid !important;grid-template-columns:repeat(4,1fr);gap:0;margin-top:10px;background:#fff;border:1px solid rgba(20,34,46,.12);border-radius:18px;box-shadow:0 14px 34px -26px rgba(20,34,46,.3);overflow:hidden}
.statrow .si{padding:28px 24px;text-align:center;border-right:1px solid rgba(20,34,46,.12)}
.statrow .si:last-child{border-right:0}
.statrow .sn{font:800 clamp(2rem,3.2vw,2.7rem)/1 'Outfit',sans-serif;letter-spacing:-.03em;color:#155E7A;-webkit-text-fill-color:#155E7A}
.statrow .si:first-child .sn{background:linear-gradient(180deg,#155E7A,#2E9A8C);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;color:transparent}
.statrow .sn .su{font:600 .85rem/1 'Outfit',sans-serif;letter-spacing:normal;color:#5d6b76;-webkit-text-fill-color:#5d6b76;margin-left:6px}
.statrow .sl{font-size:13px;line-height:1.45;color:#5d6b76;margin-top:12px}
@media(max-width:820px){.statrow{grid-template-columns:1fr 1fr}.statrow .si:nth-child(2){border-right:0}.statrow .si:nth-child(-n+2){border-bottom:1px solid rgba(20,34,46,.12)}}
@media(max-width:480px){.statrow{grid-template-columns:1fr}.statrow .si{border-right:0;border-bottom:1px solid rgba(20,34,46,.12)}.statrow .si:last-child{border-bottom:0}}
