...
<section class="cta-band"><div class="wrap reveal">
  ...
  <div class="row">
    ...
    <a href="https://wa.me/{{ config('ukv.whatsapp') ?: '447462230788' }}?text={{ rawurlencode('Hi Beyond Passports, I have a question about my Schengen documents.') }}" class="btn btn--glass">@include('partials.wa-glyph')Chat on WhatsApp</a>
  </div>
