...
<section class="cta-band"><div class="wrap reveal">
  ...
  <div class="row">
    ...
    <a href="https://wa.me/{{ config('ukv.whatsapp') ?: '4915213103462' }}?text={{ rawurlencode('Hi Beyond Passports, I have a question about my Schengen documents.') }}" class="btn btn--glass">@include('partials.wa-glyph')Chat on WhatsApp</a>
  </div>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (steps.length === 2 && nextBtn && backBtn) {
      ...
      var show = function (n) {
        ...
        nextBtn.innerHTML = (n === 2) ? 'Get my checklist &rarr;' : 'Next: your situation &rarr;';
