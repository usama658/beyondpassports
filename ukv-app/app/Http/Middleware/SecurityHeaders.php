...
class SecurityHeaders
{
    ...
    private function strictCsp(): string
    {
        return implode('; ', [
            ...
            // static.cloudflareinsights.com: Cloudflare Web Analytics (RUM) beacon, auto-injected
            // by the CF proxy. Its POST goes to cloudflareinsights.com (see connect-src).
            "script-src 'self' 'unsafe-inline' https://js.stripe.com https://widget.trustpilot.com https://invitejs.trustpilot.com https://www.googletagmanager.com https://www.google-analytics.com https://*.clarity.ms https://connect.facebook.net https://googleads.g.doubleclick.net https://www.googleadservices.com https://static.cloudflareinsights.com",
            ...
            // go.beyondpassports.co.uk: the wa-click attribution beacon + form->CRM post
            // (partials/utm-capture -> visacrm-production). Without it the strict CSP blocks navigator.sendBeacon.
            "connect-src 'self' https://go.beyondpassports.co.uk https://visacrm-production.up.railway.app https://api.stripe.com https://widget.trustpilot.com https://*.trustpilot.com https://www.google-analytics.com https://*.google-analytics.com https://analytics.google.com https://*.analytics.google.com https://www.googletagmanager.com https://tagassistant.google.com https://*.clarity.ms https://connect.facebook.net https://www.facebook.com https://www.google.com https://googleads.g.doubleclick.net https://stats.g.doubleclick.net https://ad.doubleclick.net https://www.googleadservices.com https://cloudflareinsights.com https://static.cloudflareinsights.com",
