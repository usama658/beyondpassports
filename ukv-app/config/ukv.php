...
return [
    ...
    'phone' => env('UKV_PHONE', '+49 1521 3103462'),      // human-readable display
    'phone_e164' => env('UKV_PHONE_E164', '+4915213103462'),  // for tel: links
    ...
    'whatsapp' => env('UKV_WHATSAPP', '4915213103462'),   // wa.me number (digits only)
    'whatsapp_secondary' => env('UKV_WHATSAPP_SECONDARY', '4915213103462'), // 2nd line (+49 1521 3103462); "Talk to an Expert" CTAs route here
    ...
    'team' => [
        ['name' => 'Sarah Whitmore', 'role' => 'Lead Visa Consultant', 'bio' => 'Personally checks every application before it is submitted, nothing outsourced.', 'lead' => true, 'photo' => '/assets/img/team/lena-vogel-germany-lead.jpg?v=3', 'email' => 'consultant@beyondpassports.co.uk'],
        ['name' => 'James Whitfield', 'role' => 'Refusal-Recovery Specialist', 'bio' => 'Decodes refusal letters, finds the real trigger, and rebuilds the file, or tells you honestly when it cannot be recovered.', 'lead' => false, 'photo' => '/assets/img/team/james-whitfield-operations.jpg?v=3', 'email' => 'refusals@beyondpassports.co.uk'],
        ['name' => 'Zayla Ferreira', 'role' => 'Appointments & Client Coordinator', 'bio' => 'Monitors slots across all 29 countries daily and keeps you updated at every step.', 'lead' => false, 'photo' => '/assets/img/team/zayla-ferreira-appointments.jpg?v=3', 'email' => 'appointments@beyondpassports.co.uk'],
    ...
    'team_whatsapp' => env('UKV_TEAM_WHATSAPP', '4915213103462'),
    ...
    'lp_default_hero' => [
        ...
        'h1_lead' => 'Schengen Visa Services with ',
        'h1_gold' => 'Fast-Tracked Paperwork for UK Residents.',
    ...
    'trustpilot' => [
        ...
        'review_token'     => env('UKV_TRUSTPILOT_REVIEW_TOKEN', '92382248-483f-4956-93da-09944cc91c14'), // required by the Review Collector template
        'domain'           => env('UKV_TRUSTPILOT_DOMAIN', 'beyondpassports.co.uk'),         // your verified review domain
        'profile_url'      => env('UKV_TRUSTPILOT_PROFILE_URL', 'https://trstp.lt/tf7HiLGmh7'), // public review-collection link (fallback CTA)
    ...
    'tours' => [
        ...
        'packages' => [
            ['name' => 'Paris Long Weekend',     'where' => 'France',                        'days' => '4 days',  'flagship' => false, 'flag' => 'linear-gradient(90deg,#0055A4 33%,#fff 33% 66%,#EF4135 66%)',                 'img' => "url('/assets/tours/paris.jpg') center/cover no-repeat, linear-gradient(135deg,#485563,#29323c)", 'bens' => ['Schengen visa documents prepared', 'Airport transfers on arrival', 'Central Paris hotel, 3 nights']],
            ['name' => 'Italy Highlights',       'where' => 'Rome · Florence · Venice',       'days' => '7 days',  'flagship' => false, 'flag' => 'linear-gradient(90deg,#009246 33%,#fff 33% 66%,#CE2B37 66%)',                 'img' => "url('/assets/tours/italy.jpg') center/cover no-repeat, linear-gradient(135deg,#8e2de2,#4a1042)", 'bens' => ['Schengen visa documents prepared', 'Internal rail between cities', 'Rome, Florence & Venice, 6 nights']],
            ['name' => 'Greek Islands Escape',   'where' => 'Greece',                         'days' => '7 days',  'flagship' => false, 'flag' => 'linear-gradient(180deg,#0D5EAF 0 20%,#fff 20% 40%,#0D5EAF 40% 60%,#fff 60% 80%,#0D5EAF 80%)', 'img' => "url('/assets/tours/greece.jpg') center/cover no-repeat, linear-gradient(135deg,#1c92d2,#2b5876)", 'bens' => ['Schengen visa documents prepared', 'Inter-island ferry transfers', 'Athens & island hotels, 6 nights']],
            ['name' => 'Amsterdam & the Rhine',  'where' => 'Netherlands + Germany',          'days' => '6 days',  'flagship' => false, 'flag' => 'linear-gradient(90deg,#21468B 50%,#FFCE00 50%)',                             'img' => "url('/assets/tours/amsterdam.jpg') center/cover no-repeat, linear-gradient(135deg,#134e5e,#71b280)", 'bens' => ['Schengen visa documents prepared', 'Rhine river transfers', 'Amsterdam & Rhine hotels, 5 nights']],
            ['name' => 'Spain & Portugal',       'where' => 'Spain + Portugal',               'days' => '10 days', 'flagship' => false, 'flag' => 'linear-gradient(90deg,#AA151B 50%,#046A38 50%)',                             'img' => "url('/assets/tours/spain-portugal.jpg') center/cover no-repeat, linear-gradient(135deg,#c04848,#480048)", 'bens' => ['Schengen visa documents prepared', 'Inter-city rail between cities', 'Madrid, Lisbon & Seville, 9 nights']],
            ['name' => 'Best of Western Europe', 'where' => 'France · Switzerland · Italy',    'days' => '14 days', 'flagship' => true,  'flag' => 'linear-gradient(90deg,#0055A4 33%,#DA291C 33% 66%,#009246 66%)',             'img' => "url('/assets/tours/western-europe.jpg') center/cover no-repeat, linear-gradient(135deg,#0f2027,#203a43,#2c5364)", 'bens' => ['Schengen visa documents prepared', 'Scenic first-class rail journeys', 'France, Switzerland & Italy, 13 nights']],
        ],
    ],
