...
return [
    ...
    'tours' => [
        ...
        'packages' => [
            ...
            ['name' => 'Greek Islands Escape',   'where' => 'Greece',                         'days' => '7 days',  'flagship' => false, 'flag' => 'linear-gradient(180deg,#0D5EAF,#fff)',                                      'img' => "url('/assets/tours/greece.jpg') center/cover no-repeat, linear-gradient(135deg,#1c92d2,#2b5876)", 'bens' => ['Schengen visa prepared in-house', 'Biometric appointment booked', 'Return flights + island ferries', 'Athens & island hotels, 6 nights']],
            ['name' => 'Amsterdam & the Rhine',  'where' => 'Netherlands + Germany',          'days' => '6 days',  'flagship' => false, 'flag' => 'linear-gradient(180deg,#AE1C28 33%,#fff 33% 66%,#21468B 66%)',                'img' => "url('/assets/tours/amsterdam.jpg') center/cover no-repeat, linear-gradient(135deg,#134e5e,#71b280)", 'bens' => ['Schengen visa prepared in-house', 'Biometric appointment booked', 'Return flights + Rhine transfers', 'Amsterdam & Rhine hotels, 5 nights']],
            ['name' => 'Spain & Portugal',       'where' => 'Spain + Portugal',               'days' => '10 days', 'flagship' => false, 'flag' => 'linear-gradient(180deg,#AA151B 40%,#F1BF00 40% 60%,#AA151B 60%)',             'img' => "url('/assets/tours/spain-portugal.jpg') center/cover no-repeat, linear-gradient(135deg,#c04848,#480048)", 'bens' => ['Schengen visa prepared in-house', 'Biometric appointment booked', 'Return flights + inter-city rail', 'Madrid, Lisbon & Seville, 9 nights']],
            ['name' => 'Best of Western Europe', 'where' => 'France · Switzerland · Italy',    'days' => '14 days', 'flagship' => true,  'flag' => 'linear-gradient(90deg,#0055A4,#fff,#CE2B37)',                                'img' => "url('/assets/tours/western-europe.jpg') center/cover no-repeat, linear-gradient(135deg,#0f2027,#203a43,#2c5364)", 'bens' => ['Schengen visa prepared in-house', 'Biometric appointment booked', 'Return flights + scenic first-class rail', 'France, Switzerland & Italy, 13 nights']],
        ],
    ],
