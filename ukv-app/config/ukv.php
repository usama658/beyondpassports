...
return [
    ...
    'team' => [
        ['name' => 'Sarah Whitmore', 'role' => 'Lead Visa Consultant', 'bio' => 'Personally checks every application before it is submitted, nothing outsourced.', 'lead' => true, 'photo' => '/assets/img/team/lena-vogel-germany-lead.jpg?v=2', 'email' => 'consultant@beyondpassports.co.uk'],
        ['name' => 'James Whitfield', 'role' => 'Refusal-Recovery Specialist', 'bio' => 'Decodes refusal letters, finds the real trigger, and rebuilds the file, or tells you honestly when it cannot be recovered.', 'lead' => false, 'photo' => '/assets/img/team/james-whitfield-operations.jpg?v=2', 'email' => 'refusals@beyondpassports.co.uk'],
        ['name' => 'Chloe Adams', 'role' => 'Appointments & Client Coordinator', 'bio' => 'Monitors slots across all 29 countries daily and keeps you updated at every step.', 'lead' => false, 'photo' => '/assets/img/team/chloe-adams-appointments-coordinator.jpg?v=2', 'email' => 'appointments@beyondpassports.co.uk'],
