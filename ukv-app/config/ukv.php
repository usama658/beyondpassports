...
return [
    ...
    'phone' => env('UKV_PHONE', '+44 7520 684030'),      // human-readable display
    'phone_e164' => env('UKV_PHONE_E164', '+447520684030'),  // for tel: links
    ...
    'whatsapp' => env('UKV_WHATSAPP', '447520684030'),   // wa.me number (digits only)
    'whatsapp_secondary' => env('UKV_WHATSAPP_SECONDARY', '447520684030'), // 2nd line (+44 7520 684030); "Talk to an Expert" CTAs route here
    ...
    'team_whatsapp' => env('UKV_TEAM_WHATSAPP', '447520684030'),
